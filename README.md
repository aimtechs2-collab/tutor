...
<p align="center">
  <a href="https://aimtutor.info" target="_blank"><img alt="Docs — aimtutor.info" src="https://img.shields.io/badge/Docs-aimtutor.info%20%E2%86%97-0A0A0A?style=for-the-badge&labelColor=F5F5F4" height="36"></a>
</p>
...
[Features](#-key-features) · [Get Started](#-get-started) · [Explore](#-explore-aimtutor) · [TutorBot](#-tutorbot--persistent-autonomous-ai-tutors) · [CLI](#%EF%B8%8F-aimtutor-cli--agent-native-interface) · [Multi-User](#-multi-user--shared-deployments-with-per-user-workspaces) · [Community](#-community--ecosystem)

</div>

---

> 🤝 **We welcome any kinds of contributing!** Vote on roadmap items or propose new ones at [`Roadmap`](https://github.com/HKUDS/AIMTutor/issues/498), and see our [Contributing Guide](CONTRIBUTING.md) for branching strategy, coding standards, and how to get started.

### 📦 Releases

> **[2026.5.22]** [v1.4.0](https://github.com/HKUDS/AIMTutor/releases/tag/v1.4.0) — GA cut of v1.4: Auto Mode, three-layer Memory, agentic Deep Research / Solve / Question, LlamaIndex RAG refactor, Visualize/Animator merge, plus reasoning-effort normalization, tool-schema fallback, and restart-safe turn runtime.

> **[2026.5.21]** [v1.4.0-beta](https://github.com/HKUDS/AIMTutor/releases/tag/v1.4.0-beta) — Three-layer Memory workbench (L1/L2/L3), every chat capability rebuilt on a single agentic engine, LlamaIndex-only RAG, and a unified Settings + Capabilities surface.

> **[2026.5.10]** [v1.3.10](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.10) — Remote Docker CORS recovery, `DISABLE_SSL_VERIFY` across SDK providers, safer code-block citations, and optional Matrix E2EE add-on.

> **[2026.5.9]** [v1.3.9](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.9) — TutorBot Zulip and NVIDIA NIM support, safer thinking-model routing, `aimtutor start`, sidebar tooltips, and session-store parity.

<details>
<summary><b>Past releases (more than 2 weeks ago)</b></summary>

> **[2026.5.8]** [v1.3.8](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.8) — Optional multi-user deployments with isolated user workspaces, admin grants, auth routes, and scoped runtime access.

> **[2026.5.4]** [v1.3.7](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.7) — Thinking-model/provider fixes, visible Knowledge index history, and safer Co-Writer clear/template editing.

> **[2026.5.3]** [v1.3.6](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.6) — Catalog-based model selection for chat and TutorBot, safer RAG re-indexing, OpenAI Responses token-limit fixes, and Skills editor validation.

> **[2026.5.2]** [v1.3.5](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.5) — Smoother local launch settings, safer RAG queries, cleaner local embedding auth, and Settings dark-mode polish.

> **[2026.5.1]** [v1.3.4](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.4) — Book page chat persistence and rebuild flows, chat-to-book references, stronger language/reasoning handling, RAG document extraction hardening.

> **[2026.4.30]** [v1.3.3](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.3) — NVIDIA NIM + Gemini embedding support, unified Space context for chat history/skills/memory, session snapshots, RAG re-index resilience.

> **[2026.4.29]** [v1.3.2](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.2) — Transparent embedding endpoint URLs, RAG re-index resilience for invalid persisted vectors, memory cleanup for thinking-model output, Deep Solve runtime fix.

> **[2026.4.28]** [v1.3.1](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.1) — Stability: safer RAG routing & embedding validation, Docker persistence, IME-safe input, Windows/GBK robustness.

> **[2026.4.27]** [v1.3.0](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.0) — Versioned KB indexes with re-index workflow, rebuilt Knowledge workspace, embedding auto-discovery with new adapters, Space hub.

> **[2026.4.25]** [v1.2.5](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.5) — Persistent chat attachments with file-preview drawer, attachment-aware capability pipelines, TutorBot Markdown export.

> **[2026.4.25]** [v1.2.4](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.4) — Text/code/SVG attachments, one-command Setup Tour, Markdown chat export, compact KB management UI.

> **[2026.4.24]** [v1.2.3](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.3) — Document attachments (PDF/DOCX/XLSX/PPTX), reasoning thinking-block display, Soul template editor, Co-Writer save-to-notebook.

> **[2026.4.22]** [v1.2.2](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.2) — User-authored Skills system, chat input performance overhaul, TutorBot auto-start, Book Library UI, visualization fullscreen.

> **[2026.4.21]** [v1.2.1](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.1) — Per-stage token limits, Regenerate response across all entry points, RAG & Gemma compatibility fixes.

> **[2026.4.20]** [v1.2.0](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.0) — Book Engine "living book" compiler, multi-document Co-Writer, interactive HTML visualizations, Question Bank @-mention.

> **[2026.4.18]** [v1.1.2](https://github.com/HKUDS/AIMTutor/releases/tag/v1.1.2) — Schema-driven Channels tab, RAG single-pipeline consolidation, externalized chat prompts.

> **[2026.4.17]** [v1.1.1](https://github.com/HKUDS/AIMTutor/releases/tag/v1.1.1) — Universal "Answer now", Co-Writer scroll sync, unified settings panel, streaming Stop button.

> **[2026.4.15]** [v1.1.0](https://github.com/HKUDS/AIMTutor/releases/tag/v1.1.0) — LaTeX block math overhaul, LLM diagnostic probe, Docker + local LLM guidance.

> **[2026.4.14]** [v1.1.0-beta](https://github.com/HKUDS/AIMTutor/releases/tag/v1.1.0-beta) — Bookmarkable sessions, Snow theme, WebSocket heartbeat & auto-reconnect, embedding registry overhaul.

> **[2026.4.13]** [v1.0.3](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.3) — Question Notebook with bookmarks & categories, Mermaid in Visualize, embedding mismatch detection, Qwen/vLLM compatibility, LM Studio & llama.cpp support, and Glass theme.

> **[2026.4.11]** [v1.0.2](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.2) — Search consolidation with SearXNG fallback, provider switch fix, and frontend resource leak fixes.

> **[2026.4.10]** [v1.0.1](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.1) — Visualize capability (Chart.js/SVG), quiz duplicate prevention, and o4-mini model support.

> **[2026.4.10]** [v1.0.0-beta.4](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.0-beta.4) — Embedding progress tracking with rate-limit retry, cross-platform dependency fixes, and MIME validation fix.

> **[2026.4.8]** [v1.0.0-beta.3](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.0-beta.3) — Native OpenAI/Anthropic SDK (drop litellm), Windows Math Animator support, robust JSON parsing, and full Chinese i18n.

> **[2026.4.7]** [v1.0.0-beta.2](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.0-beta.2) — Hot settings reload, MinerU nested output, WebSocket fix, and Python 3.11+ minimum.

> **[2026.4.4]** [v1.0.0-beta.1](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.0-beta.1) — Agent-native architecture rewrite (~200k lines): Tools + Capabilities plugin model, CLI & SDK, TutorBot, Co-Writer, Guided Learning, and persistent memory.

> **[2026.1.23]** [v0.6.0](https://github.com/HKUDS/AIMTutor/releases/tag/v0.6.0) — Session persistence, incremental document upload, flexible RAG pipeline import, and full Chinese localization.

> **[2026.1.18]** [v0.5.2](https://github.com/HKUDS/AIMTutor/releases/tag/v0.5.2) — Docling support for RAG-Anything, logging system optimization, and bug fixes.

> **[2026.1.15]** [v0.5.0](https://github.com/HKUDS/AIMTutor/releases/tag/v0.5.0) — Unified service configuration, RAG pipeline selection per knowledge base, question generation overhaul, and sidebar customization.

> **[2026.1.9]** [v0.4.0](https://github.com/HKUDS/AIMTutor/releases/tag/v0.4.0) — Multi-provider LLM & embedding support, new home page, RAG module decoupling, and environment variable refactor.

> **[2026.1.5]** [v0.3.0](https://github.com/HKUDS/AIMTutor/releases/tag/v0.3.0) — Unified PromptManager architecture, GitHub Actions CI/CD, and pre-built Docker images on GHCR.

> **[2026.1.2]** [v0.2.0](https://github.com/HKUDS/AIMTutor/releases/tag/v0.2.0) — Docker deployment, Next.js 16 & React 19 upgrade, WebSocket security hardening, and critical vulnerability fixes.

</details>

### 📰 News

> **[2026.5.22]** 🌐 Our official docs site is live at [**aimtutor.info**](https://aimtutor.info/) — guides, references, and capability tours all in one place.
...
> **[2026.4.10]** 📄 Our paper is now live on arXiv! Read the [preprint](https://arxiv.org/abs/2604.26962) to learn more about the design and ideas behind AIMTutor.

> **[2026.4.4]** Long time no see! ✨ AIMTutor v1.0.0 is finally here — an agent-native evolution featuring a ground-up architecture rewrite, TutorBot, and flexible mode switching under the Apache-2.0 license. A new chapter begins, and our story continues!

> **[2026.2.6]** 🚀 We've reached 10k stars in just 39 days! A huge thank you to our incredible community for the support!

> **[2026.1.1]** Happy New Year! Join our [Discord](https://discord.gg/eRsjPgMU4t), [WeChat](https://github.com/HKUDS/AIMTutor/issues/78), or [Discussions](https://github.com/HKUDS/AIMTutor/discussions) — let's shape the future of AIMTutor together!

> **[2025.12.29]** AIMTutor is officially released!
...
- Space — a personal review library bundling chat history, notebooks, question bank, and user-authored skills (`SKILL.md`) that switch AIMTutor's persona.
- Three-layer memory — append-only L1 traces, L2 per-surface curated facts with citations, and L3 cross-surface synthesis. An inspectable workbench and a memory graph let you audit *why* AIMTutor knows what it knows.
...
- Agent-native CLI — every capability, KB, session, and TutorBot is one command away; rich output for humans, structured JSON for agents. Hand any tool-using LLM the [`SKILL.md`](SKILL.md) and it can drive AIMTutor on its own.
...
AIMTutor ships four installation paths. They all share one workspace layout: settings live in `data/user/settings/` under the directory you launch from (or under `AIMTUTOR_HOME` / `aimtutor start --home` if you set one explicitly). For the full app, the recommended flow is **pick a workspace directory → install → `aimtutor init` → `aimtutor start`**.

> ✨ **v1.4.0 is live.** `pip install -U aimtutor` picks up the latest stable. Pre-releases (when available) opt in with `pip install --pre -U aimtutor`.

### Option 1 — Install From PyPI

Full local Web app + CLI, no clone required. Needs **Python 3.11+** and a **Node.js 20+** runtime on PATH (the packaged Next.js standalone server is spawned by `aimtutor start`).

```bash
mkdir -p my-aimtutor && cd my-aimtutor
pip install -U aimtutor
aimtutor init     # prompts for ports + LLM provider + optional embedding
aimtutor start    # starts backend + frontend; keep the terminal open
```

`aimtutor init` prompts for backend port (default `8001`), frontend port (default `3782`), LLM provider / base URL / API key / model, and an optional embedding provider for Knowledge Base / RAG.

After `aimtutor start`, open the frontend URL printed in the terminal — by default [http://127.0.0.1:3782](http://127.0.0.1:3782). Press `Ctrl+C` in that terminal to stop both backend and frontend. Skipping `aimtutor init` is fine for a quick trial; the app boots with default ports and empty model settings, configure them later in **Settings → Models**.
...
**Stuck dev server:** if `aimtutor start` reports an existing frontend that isn't responding, stop the PID it prints. If no Next.js process is actually running, the lock files are stale — remove them and retry:
...
- `ghcr.io/hkuds/aimtutor:latest` — stable release
- `ghcr.io/hkuds/aimtutor:pre` — pre-release, when available
...
Open [http://127.0.0.1:3782](http://127.0.0.1:3782). The container creates `/app/data/user/settings/*.json` on first boot; configure model providers from the Web Settings page. Config, API keys, logs, workspace files, memory, and knowledge bases persist in the `aimtutor-data` volume.
...
- **Detached:** add `-d`, then `docker logs -f aimtutor` to follow, `docker stop aimtutor` to stop, `docker rm aimtutor` before reusing the name. The `aimtutor-data` volume keeps your settings and workspace across restarts.
...
`aimtutor init --cli` shares the same `data/user/settings/` layout as the full app but skips the backend/frontend port prompts and defaults embeddings to **off** (choose `Yes` if you plan to use `aimtutor kb …` or RAG tools). It still writes a complete runtime layout (`system.json`, `auth.json`, `integrations.json`, `model_catalog.json`, `main.yaml`, `agents.yaml`) and still prompts for the active LLM provider and model.

<details>
<summary><b>Common commands</b></summary>

```bash
aimtutor chat                                          # interactive REPL
...
The local `aimtutor-cli` install ships no Web assets or server dependencies. Keep the source checkout around — the editable install points to it. To add the Web app later, install the PyPI package (Option 1) and run `aimtutor init` + `aimtutor start` from the same workspace.
...
The v1.4.0-beta refactor reorganises AIMTutor around **five core surfaces** — Chat, Co-Writer, Book, Knowledge, Space — plus a **three-layer Memory** that sits underneath all of them and a unified **Settings** workbench that exposes every knob. Capabilities (Solve / Quiz / Research / Visualize) and tools (RAG, web, code, reason, brainstorm, paper search, `ask_user`, `web_fetch`, `write_note`, `list_notebook`, `github_query`) compose freely on top.
...
Select any text and choose **Rewrite**, **Expand**, or **Shorten** — every action runs as a tracked agent edit that can optionally pull from a knowledge base or the web. Co-Writer renders standard Markdown / CommonMark / GFM (tables, code, math, flowcharts, sequence diagrams), supports a HTML tag escape hatch (`<sub>`, `<sup>`, `<abbr>`, `<mark>`), and ships a starter template tuned for AIMTutor product docs and learning notes.
...
Give AIMTutor a topic, point it at your knowledge base, and it produces a structured, interactive book — not a static export, but a living document you can read, quiz yourself on, and discuss in context.
...
Pages are assembled from 13 block types — text, callout, quiz, flash cards, code, figure, deep dive, animation, interactive demo (now including a **GeoGebra viewer**), timeline, concept graph, section, and user note — each rendered with its own interactive component. Book pages are fingerprinted against their source KB; `aimtutor book health` reports drift and `aimtutor book refresh-fingerprints` clears stale pages when sources change.
...
- **Skills** — User-authored `SKILL.md` files that define teaching personas (name, description, triggers, body). When active, a skill is injected into the chat system prompt — turning AIMTutor into a Socratic tutor, a research assistant, or any role you design.
...
AIMTutor's memory is now a **three-layer pipeline** with an inspectable workbench at `/memory`. The two-file v1 `SUMMARY.md` / `PROFILE.md` model is gone; everything is migrated into the new layout on first boot.
...
- **Independent Workspace** — Each bot has its own directory with separate memory, sessions, skills, and configuration — fully isolated yet able to access AIMTutor's shared knowledge layer.
...
- **Full Tool Access** — Every bot reaches into AIMTutor's complete toolkit: RAG retrieval, code execution, web search, academic paper search, deep reasoning, and brainstorming.
...
aimtutor bot list                  # See all your active tutors
```

---

### ⌨️ AIMTutor CLI — Agent-Native Interface

<div align="center">
<img src="assets/figs/cli-architecture.png" alt="AIMTutor CLI Architecture" width="800">
</div>

AIMTutor is fully CLI-native. Every capability, knowledge base, session, memory, and TutorBot is one command away — no browser required. The CLI serves both humans (with rich terminal rendering) and AI agents (with structured JSON output).

Hand the [`SKILL.md`](SKILL.md) at the project root to any tool-using agent ([nanobot](https://github.com/HKUDS/nanobot), or any LLM with tool access), and it can configure and operate AIMTutor autonomously.
...
```bash
aimtutor kb create my-kb --doc textbook.pdf       # Create from document
aimtutor kb add my-kb --docs-dir ./papers/         # Add a folder of papers
aimtutor kb search my-kb "gradient descent"        # Search directly
aimtutor kb set-default my-kb                      # Set as default for all commands
```

**Dual output mode** — Rich rendering for humans, structured JSON for pipelines:

```bash
aimtutor run chat "Summarize chapter 3" -f rich    # Colored, formatted output
aimtutor run chat "Summarize chapter 3" -f json    # Line-delimited JSON events
```

**Session continuity** — Resume any conversation right where you left off:

```bash
aimtutor session list                              # List all sessions
aimtutor session open <id>                         # Resume in REPL
```
...
| Command | Description |
|:---|:---|
| `aimtutor run <capability> <message>` | Run any capability in a single turn (`chat`, `deep_solve`, `deep_question`, `deep_research`, `math_animator`, `visualize`) |
| `aimtutor chat` | Interactive REPL with optional `--capability`, `--tool`, `--kb`, `--language` |
| `aimtutor serve` | Start the AIMTutor API server |
...
| `aimtutor bot create <id>` | Create and start a new bot (`--name`, `--persona`, `--model`) |
...
| `aimtutor kb create <name>` | Create from documents (`--doc`, `--docs-dir`) |
| `aimtutor kb add <name>` | Add documents incrementally |
| `aimtutor kb search <name> <query>` | Search a knowledge base |
| `aimtutor kb set-default <name>` | Set as default KB |
| `aimtutor kb delete <name>` | Delete a knowledge base (`--force`) |

**`aimtutor memory`**

| Command | Description |
|:---|:---|
| `aimtutor memory show [file]` | View memory (`summary`, `profile`, or `all`) |
| `aimtutor memory clear [file]` | Clear memory (`--force`) |

**`aimtutor session`**

| Command | Description |
|:---|:---|
| `aimtutor session list` | List sessions (`--limit`) |
| `aimtutor session show <id>` | View session messages |
| `aimtutor session open <id>` | Resume session in REPL |
| `aimtutor session rename <id>` | Rename a session (`--title`) |
...
| `aimtutor notebook create <name>` | Create a notebook (`--description`) |
| `aimtutor notebook show <id>` | View notebook records |
| `aimtutor notebook add-md <id> <path>` | Import markdown as record |
| `aimtutor notebook replace-md <id> <rec> <path>` | Replace a markdown record |
...
| Command | Description |
|:---|:---|
| `aimtutor book list` | List all books in the workspace |
| `aimtutor book health <book_id>` | Check KB drift and book health |
| `aimtutor book refresh-fingerprints <book_id>` | Refresh KB fingerprints and clear stale pages |

**`aimtutor config` / `plugin` / `provider`**

| Command | Description |
|:---|:---|
| `aimtutor config show` | Print current configuration summary |
| `aimtutor plugin list` | List registered tools and capabilities |
| `aimtutor plugin info <name>` | Show tool or capability details |
| `aimtutor provider login <provider>` | Provider auth (`openai-codex` OAuth login; `github-copilot` validates an existing Copilot auth session) |
...
| `data/user/settings/system.json` | No | `aimtutor start` derives frontend auth flags and API base from runtime settings. |
...
AIMTutor stands on the shoulders of outstanding open-source projects:

| Project | Role in AIMTutor |
|:---|:---|
...
We hope AIMTutor becomes a gift for the community. 🎁
...
[⭐ Star us](https://github.com/HKUDS/AIMTutor/stargazers) · [🐛 Report a bug](https://github.com/HKUDS/AIMTutor/issues) · [💬 Discussions](https://github.com/HKUDS/AIMTutor/discussions)
