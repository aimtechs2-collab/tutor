...
from aimtutor_cli.init_cmd import run_init  # noqa: E402


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Create or update AIMTutor settings under data/user/settings.",
    )
    parser.add_argument(
        "--cli",
        action="store_true",
