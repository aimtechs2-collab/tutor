...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "Docker settings: "
        f"backend={values['AIMTUTOR_DOCKER_BACKEND_PORT']} "
        f"frontend={values['AIMTUTOR_DOCKER_FRONTEND_PORT']} "
        f"pocketbase={values['AIMTUTOR_DOCKER_POCKETBASE_PORT']}",
        file=sys.stderr,
    )
