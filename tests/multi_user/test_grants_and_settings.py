...
from aimtutor.multi_user.grants import save_grant
from aimtutor.multi_user.models import CurrentUser, UserScope
...
def test_grants_reject_secret_material(tmp_path, monkeypatch):
    from aimtutor.multi_user import grants, identity
...
def test_grants_reject_admin_users(tmp_path, monkeypatch):
    from aimtutor.multi_user import grants
