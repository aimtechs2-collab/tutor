...
memory_router = importlib.import_module("aimtutor.api.routers.memory").router
paths_mod = importlib.import_module("aimtutor.services.memory.paths")
document_mod = importlib.import_module("aimtutor.services.memory.document")
