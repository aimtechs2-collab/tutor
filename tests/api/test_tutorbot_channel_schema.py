...
class TestResolveConfigModel:
    def test_telegram_pairs_with_telegram_config(self) -> None:
        from aimtutor.tutorbot.channels.telegram import TelegramChannel, TelegramConfig

        assert resolve_config_model(TelegramChannel) is TelegramConfig

    def test_slack_pairs_with_slack_config(self) -> None:
        from aimtutor.tutorbot.channels.slack import SlackChannel, SlackConfig

        assert resolve_config_model(SlackChannel) is SlackConfig

    def test_discord_pairs_with_discord_config(self) -> None:
        from aimtutor.tutorbot.channels.discord import DiscordChannel, DiscordConfig
...
class TestChannelSchemaPayload:
    def test_telegram_payload_shape(self) -> None:
        from aimtutor.tutorbot.channels.telegram import TelegramChannel
    ...
    def test_slack_dm_subtree_inlined(self) -> None:
        from aimtutor.tutorbot.channels.slack import SlackChannel
...
class TestEndpoint:
    ...
    def client(self) -> TestClient:
        ...
        from aimtutor.api.routers import tutorbot as tutorbot_router
