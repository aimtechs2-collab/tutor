...
AGENTS_DIR = PROJECT_ROOT / "aimtutor" / "agents"
# Modules that live outside aimtutor/agents/ but still own prompts.
EXTRA_PROMPT_MODULE_DIRS = (
    PROJECT_ROOT / "aimtutor" / "book",
    PROJECT_ROOT / "aimtutor" / "co_writer",
)
