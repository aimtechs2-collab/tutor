...
def _load_question_extractor_module():
    ...
    stubbed_modules = {
        "aimtutor.services.config": {"get_agent_params": lambda *_args, **_kwargs: {}},
        "aimtutor.services.llm": {"complete": lambda *_args, **_kwargs: None},
        "aimtutor.services.llm.capabilities": {
            "supports_response_format": lambda *_args, **_kwargs: False
        },
        "aimtutor.services.llm.config": {"get_llm_config": lambda: None},
        "aimtutor.utils.json_parser": {"parse_json_response": lambda *_args, **_kwargs: {}},
    }
