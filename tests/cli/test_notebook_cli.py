"""CLI smoke tests for ``aimtutor notebook`` commands."""
...
from aimtutor_cli.main import app
...
def _patch_facade(monkeypatch) -> None:
    """Patch AIMTutorApp methods to use the shared fake manager."""
    ...
    from aimtutor.app import facade

    monkeypatch.setattr(facade.AIMTutorApp, "create_notebook", _create_notebook)
    monkeypatch.setattr(facade.AIMTutorApp, "get_notebook", _get_notebook)
    monkeypatch.setattr(facade.AIMTutorApp, "add_record", _add_record)
    monkeypatch.setattr(facade.AIMTutorApp, "update_record", _update_record)
    monkeypatch.setattr(facade.AIMTutorApp, "remove_record", _remove_record)
