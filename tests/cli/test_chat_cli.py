"""CLI smoke tests for the standalone ``aimtutor-cli`` package."""
...
from aimtutor.app import TurnRequest
...
def _install_fake_runtime(monkeypatch, captured_requests: list[TurnRequest]) -> None:
    ...
    monkeypatch.setattr("aimtutor.app.facade.AIMTutorApp.start_turn", _start_turn)
    monkeypatch.setattr("aimtutor.app.facade.AIMTutorApp.stream_turn", _stream_turn)
...
def test_session_list_command_uses_shared_store(monkeypatch) -> None:
    ...
    monkeypatch.setattr("aimtutor.app.facade.AIMTutorApp.list_sessions", _list_sessions)
...
def test_start_command_delegates_to_runtime_launcher(monkeypatch) -> None:
    ...
    monkeypatch.setattr("aimtutor.runtime.launcher.start", _fake_start)
