...
def test_startup_ensure_creates_missing_runtime_jsons_with_defaults(
    ...
    from aimtutor.services.config import model_catalog as model_catalog_module
    from aimtutor.services.config import runtime_settings as runtime_settings_module
