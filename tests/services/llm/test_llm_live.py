...
async def run_test(
    *,
    ...
    from aimtutor.services.llm import config as config_module
    from aimtutor.services.llm.config import LLMConfig, get_llm_config
    ...
    try:
        from aimtutor.services.llm.factory import complete

        t0 = time.perf_counter()
        resp = await complete(
            "Reply with exactly: HELLO_AIMTUTOR",
    ...
    if test_stream:
        ...
        try:
            from aimtutor.services.llm.factory import stream
