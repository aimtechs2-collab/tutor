...
def test_loader_extracts_chat_supported_office_files(tmp_path: Path) -> None:
    ...
    from aimtutor.services.rag.pipelines.llamaindex.document_loader import (
...
def test_loader_skips_images_when_embedding_provider_is_text_only(
    ...
    pytest.importorskip("llama_index.core")
    from aimtutor.services.rag.pipelines.llamaindex import document_loader as loader_module
