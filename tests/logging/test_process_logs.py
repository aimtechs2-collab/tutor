...
from aimtutor.logging import ProcessLogEvent, bind_log_context, capture_process_logs


def test_capture_process_logs_emits_structured_event_for_matching_task():
    events: list[ProcessLogEvent] = []
    logger = logging.getLogger("aimtutor.tests.process")
    ...
    assert event["logger"] == "aimtutor.tests.process"
