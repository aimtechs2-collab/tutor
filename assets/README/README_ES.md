...
# AIMTutor: Tutoría Personalizada Nativa para Agentes
...
[Características](#key-features) · [Primeros pasos](#get-started) · [Explorar](#explore-aimtutor) · [TutorBot](#tutorbot) · [CLI](#aimtutor-cli) · [Multiusuario](#multi-user) · [Comunidad](#community)
...
>
> 🗺️ **La hoja de ruta** está disponible públicamente en [`HKUDS/AIMTutor#498`](https://github.com/HKUDS/AIMTutor/issues/498) — comenta para votar elementos o proponer nuevos.

### 📦 Lanzamientos

> **[2026.5.21]** [v1.4.0-beta](https://github.com/HKUDS/AIMTutor/releases/tag/v1.4.0-beta) — Panel de trabajo Memory de tres capas (L1/L2/L3), todas las capacidades de chat reconstruidas sobre un único motor agente, RAG exclusivo con LlamaIndex y una superficie unificada de Settings + Capabilities.

> **[2026.5.10]** [v1.3.10](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.10) — Corrección de CORS en Docker remoto, `DISABLE_SSL_VERIFY` para proveedores SDK, citas en bloques de código más seguras y complemento Matrix E2EE opcional.

> **[2026.5.9]** [v1.3.9](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.9) — TutorBot con soporte de Zulip y NVIDIA NIM, enrutamiento de modelos de razonamiento más seguro, `aimtutor start`, tooltips en la barra lateral y paridad del almacén de sesiones.

> **[2026.5.8]** [v1.3.8](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.8) — Despliegues multiusuario opcionales con espacios de trabajo aislados por usuario, concesión de permisos de administrador, rutas de autenticación y acceso en tiempo de ejecución con ámbito.

<details>
<summary><b>Lanzamientos anteriores (más de 2 semanas)</b></summary>

> **[2026.5.4]** [v1.3.7](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.7) — Correcciones de modelos de razonamiento/proveedores, historial de índice de Knowledge visible y edición más segura de plantillas y vaciado en Co-Writer.

> **[2026.5.3]** [v1.3.6](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.6) — Selección de modelos basada en catálogo para chat y TutorBot, reindexado RAG más seguro, correcciones de límites de tokens en OpenAI Responses y validación del editor de Skills.

> **[2026.5.2]** [v1.3.5](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.5) — Configuración de inicio local más fluida, consultas RAG más seguras, autenticación de embeddings locales más clara y mejoras visuales del modo oscuro en Settings.

> **[2026.5.1]** [v1.3.4](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.4) — Persistencia del chat en páginas de libro y flujos de reconstrucción, referencias de chat a libro, manejo mejorado de idioma/razonamiento y extracción de documentos RAG más robusta.

> **[2026.4.30]** [v1.3.3](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.3) — Soporte de embeddings NVIDIA NIM + Gemini, contexto unificado de Space para historial de chat/skills/memoria, instantáneas de sesión y resiliencia en reindexado RAG.

> **[2026.4.29]** [v1.3.2](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.2) — URLs de endpoints de embedding transparentes, resiliencia en reindexado RAG para vectores persistidos inválidos, limpieza de memoria para salida de modelos de razonamiento y corrección del tiempo de ejecución de Deep Solve.

> **[2026.4.28]** [v1.3.1](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.1) — Estabilidad: enrutamiento RAG y validación de embeddings más seguros, persistencia Docker, entrada compatible con IME, robustez en Windows/GBK.

> **[2026.4.27]** [v1.3.0](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.0) — Índices de KB versionados con flujo de reindexado, espacio de trabajo de Knowledge reconstruido, autodescubrimiento de embeddings con nuevos adaptadores y centro Space.

> **[2026.4.25]** [v1.2.5](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.5) — Adjuntos de chat persistentes con cajón de vista previa, pipelines de capacidades con soporte de adjuntos y exportación Markdown de TutorBot.

> **[2026.4.25]** [v1.2.4](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.4) — Adjuntos de texto/código/SVG, Setup Tour de un comando, exportación Markdown del chat e interfaz compacta de gestión de KB.

> **[2026.4.24]** [v1.2.3](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.3) — Adjuntos de documentos (PDF/DOCX/XLSX/PPTX), visualización de bloques de razonamiento, editor de plantillas Soul y guardado en notebook desde Co-Writer.

> **[2026.4.22]** [v1.2.2](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.2) — Sistema de Skills creados por el usuario, rendimiento mejorado en la entrada del chat, inicio automático de TutorBot, interfaz de la Biblioteca de libros y pantalla completa en visualización.

> **[2026.4.21]** [v1.2.1](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.1) — Límites de tokens por etapa, Regenerar respuesta en todos los puntos de entrada y correcciones de compatibilidad con RAG y Gemma.

> **[2026.4.20]** [v1.2.0](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.0) — Compilador de «libros vivos» Book Engine, Co-Writer multidocumento, visualizaciones HTML interactivas y mención @ en el banco de preguntas.

> **[2026.4.18]** [v1.1.2](https://github.com/HKUDS/AIMTutor/releases/tag/v1.1.2) — Pestaña Channels basada en esquema, consolidación del pipeline RAG en uno solo y prompts de chat externalizados.

> **[2026.4.17]** [v1.1.1](https://github.com/HKUDS/AIMTutor/releases/tag/v1.1.1) — «Responder ahora» universal, sincronización de desplazamiento en Co-Writer, panel de configuración unificado y botón Stop de streaming.

> **[2026.4.15]** [v1.1.0](https://github.com/HKUDS/AIMTutor/releases/tag/v1.1.0) — Revisión de bloques de matemáticas LaTeX, sonda de diagnóstico LLM y guía para Docker y LLM local.

> **[2026.4.14]** [v1.1.0-beta](https://github.com/HKUDS/AIMTutor/releases/tag/v1.1.0-beta) — Sesiones con URL favorita, tema Snow, heartbeat y reconexión automática de WebSocket y revisión del registro de embeddings.

> **[2026.4.13]** [v1.0.3](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.3) — Cuaderno de preguntas con marcadores y categorías, Mermaid en Visualize, detección de incompatibilidad de embeddings, compatibilidad con Qwen/vLLM, soporte para LM Studio y llama.cpp y tema Glass.

> **[2026.4.11]** [v1.0.2](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.2) — Consolidación de búsqueda con fallback de SearXNG, corrección del cambio de proveedor y correcciones de fugas de recursos en el frontend.

> **[2026.4.10]** [v1.0.1](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.1) — Capacidad Visualize (Chart.js/SVG), prevención de duplicados en quiz y soporte para o4-mini.

> **[2026.4.10]** [v1.0.0-beta.4](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.0-beta.4) — Seguimiento del progreso de embeddings con reintento por límite de tasa, correcciones de dependencias multiplataforma y corrección de validación MIME.

> **[2026.4.8]** [v1.0.0-beta.3](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.0-beta.3) — SDK nativo de OpenAI/Anthropic (eliminación de litellm), soporte del animador matemático en Windows, análisis robusto de JSON e i18n completo en chino.

> **[2026.4.7]** [v1.0.0-beta.2](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.0-beta.2) — Recarga en caliente de configuración, salida anidada de MinerU, corrección de WebSocket y Python 3.11+ como mínimo.

> **[2026.4.4]** [v1.0.0-beta.1](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.0-beta.1) — Reescritura de arquitectura nativa para agentes (~200k líneas): modelo de plugins Tools + Capabilities, CLI y SDK, TutorBot, Co-Writer, Aprendizaje Guiado y memoria persistente.

> **[2026.1.23]** [v0.6.0](https://github.com/HKUDS/AIMTutor/releases/tag/v0.6.0) — Persistencia de sesiones, carga incremental de documentos, importación flexible de pipeline RAG y localización completa al chino.

> **[2026.1.18]** [v0.5.2](https://github.com/HKUDS/AIMTutor/releases/tag/v0.5.2) — Soporte de Docling para RAG-Anything, optimización del sistema de logging y correcciones de errores.

> **[2026.1.15]** [v0.5.0](https://github.com/HKUDS/AIMTutor/releases/tag/v0.5.0) — Configuración unificada de servicios, selección de pipeline RAG por base de conocimiento, renovación de generación de preguntas y personalización de la barra lateral.

> **[2026.1.9]** [v0.4.0](https://github.com/HKUDS/AIMTutor/releases/tag/v0.4.0) — Soporte multi-proveedor para LLM y embeddings, nueva página de inicio, desacoplamiento del módulo RAG y refactorización de variables de entorno.

> **[2026.1.5]** [v0.3.0](https://github.com/HKUDS/AIMTutor/releases/tag/v0.3.0) — Arquitectura unificada PromptManager, CI/CD con GitHub Actions e imágenes Docker preconstruidas en GHCR.

> **[2026.1.2]** [v0.2.0](https://github.com/HKUDS/AIMTutor/releases/tag/v0.2.0) — Despliegue Docker, actualización a Next.js 16 y React 19, refuerzo de seguridad en WebSocket y correcciones de vulnerabilidades críticas.
...
> **[2026.4.10]** 📄 ¡Nuestro artículo ya está en arXiv! Lee el [preprint](https://arxiv.org/abs/2604.26962) para conocer más sobre el diseño e ideas detrás de AIMTutor.

> **[2026.4.4]** ¡Mucho tiempo sin vernos! ✨ AIMTutor v1.0.0 ya está aquí — una evolución nativa para agentes con una reescritura completa de arquitectura, TutorBot y cambio de modo flexible bajo la licencia Apache-2.0. ¡Comienza un nuevo capítulo y nuestra historia continúa!
...
> **[2026.1.1]** ¡Feliz Año Nuevo! Únete a nuestro [Discord](https://discord.gg/eRsjPgMU4t), [WeChat](https://github.com/HKUDS/AIMTutor/issues/78) o [Discusiones](https://github.com/HKUDS/AIMTutor/discussions) — ¡construyamos juntos el futuro de AIMTutor!

> **[2025.12.29]** ¡AIMTutor se lanza oficialmente!
...
- Space — una biblioteca personal de revisión que agrupa historial de chat, notebooks, banco de preguntas y skills creados por el usuario (`SKILL.md`) que cambian la personalidad de AIMTutor.
- Memoria de tres capas — trazas L1 de solo adición, hechos L2 curados por superficie con citas y síntesis L3 entre superficies. Un panel de trabajo inspeccionable y un grafo de memoria te permiten auditar *por qué* AIMTutor sabe lo que sabe.
...
- CLI nativa para agentes — cada capacidad, KB, sesión y TutorBot está a un comando de distancia; salida enriquecida para humanos, JSON estructurado para agentes. Entrega el [`SKILL.md`](../../SKILL.md) a cualquier LLM con acceso a herramientas y podrá operar AIMTutor de forma autónoma.
...
AIMTutor ahora tiene cuatro rutas de instalación paralelas. Todas utilizan el mismo esquema de configuración en tiempo de ejecución:

- Los ajustes se guardan en `data/user/settings/` bajo tu espacio de trabajo actual, o bajo `AIMTUTOR_HOME` / `aimtutor start --home` cuando eliges uno explícitamente.
...
Para la aplicación local completa, el orden recomendado es **elegir un espacio de trabajo → instalar → `aimtutor init` → `aimtutor start`**. `aimtutor start` puede completar los archivos predeterminados faltantes como red de seguridad, pero la configuración normal del primer inicio debe realizarse mediante `aimtutor init` para que los puertos y la configuración de modelos sean explícitos antes de que arranque la aplicación web.

### Opción 1 — Instalar AIMTutor
...
> 🧪 **¿Probando la beta v1.4.0?** PyPI normaliza `1.4.0-beta` a `1.4.0b0`, así que `pip install -U aimtutor` permanecerá en la versión estable más reciente. Activa la versión preliminar con:
>
> ```bash
> pip install --pre -U aimtutor      # última versión preliminar
> pip install -U aimtutor==1.4.0b0   # fijar exactamente a v1.4.0-beta
> ```

`aimtutor init` escribe la configuración en `data/user/settings/` en el directorio donde lo ejecutas. Solicita:
...
Después de `aimtutor start`, abre la URL del frontend que se imprime en el terminal. Con los puertos predeterminados, esa URL es [http://127.0.0.1:3782](http://127.0.0.1:3782). Si cambiaste `frontend_port` durante `aimtutor init` o editaste `data/user/settings/system.json` posteriormente, usa el puerto configurado.

Mantén abierto el terminal de `aimtutor start`. Presiona `Ctrl+C` en ese terminal para detener el backend y el frontend.

Notas:

- `aimtutor start` inicia el backend FastAPI y el frontend Next.js empaquetado juntos.
...
- Si omites deliberadamente `aimtutor init` para una prueba rápida, la aplicación arranca con puertos seguros por defecto y configuración de modelos vacía; configura los modelos después en **Settings → Models**.

### Opción 2 — Instalar desde el código fuente

Úsala cuando estés desarrollando AIMTutor o quieras ejecutarlo directamente desde un checkout.
...
Las instalaciones desde código fuente usan el directorio local `web/` para el frontend y lo inician en modo de desarrollo Next.js. Mantén abierto el terminal de `aimtutor start` mientras usas la aplicación.

Si `aimtutor start` reporta un frontend existente que no responde, detén el PID indicado en el mensaje. Si no hay ningún proceso Next.js en ejecución, elimina los archivos de bloqueo obsoletos y vuelve a iniciar:
...
- `ghcr.io/hkuds/aimtutor:latest` — versión estable
- `ghcr.io/hkuds/aimtutor:pre` — versión preliminar, cuando esté disponible
...
Luego abre [http://127.0.0.1:3782](http://127.0.0.1:3782). La configuración, claves API, logs, archivos del espacio de trabajo, memoria y bases de conocimiento se almacenan en el volumen `aimtutor-data` bajo `/app/data`.
...
Luego en **AIMTutor Settings → Models**, establece la URL base del proveedor en `host.docker.internal`:
...
Para detener una ejecución Docker en primer plano, presiona `Ctrl+C`. Si usaste el contenedor desacoplado con nombre, ejecuta `docker stop aimtutor`. Antes de iniciar otro contenedor con el mismo nombre, elimina el detenido con `docker rm aimtutor`; el volumen `aimtutor-data` conserva tu configuración y espacio de trabajo.
...
`aimtutor init --cli` usa el mismo esquema `data/user/settings/` que la aplicación completa, pero cambia el comportamiento del asistente:
...
- Pregunta si configurar embeddings, pero la respuesta predeterminada es `No`; elige `Sí` si planeas usar `aimtutor kb ...` o herramientas RAG.
...
aimtutor run chat "Explica la transformada de Fourier"
aimtutor run deep_solve "Resuelve x^2 = 4" --tool rag --kb my-kb
...
La instalación local de `aimtutor-cli` no incluye activos web ni dependencias del servidor. Conserva el checkout del código fuente ya que la instalación editable apunta a él.
...
Dale a AIMTutor un tema, apúntalo a tu base de conocimiento y produce un libro estructurado e interactivo — no una exportación estática, sino un documento vivo que puedes leer, hacerte preguntas sobre él y discutir en contexto.
...
La memoria de AIMTutor es ahora un **pipeline de tres capas** con un panel de trabajo inspeccionable en `/memory`. El modelo de dos archivos v1 `SUMMARY.md` / `PROFILE.md` ha desaparecido; todo se migra al nuevo esquema en el primer inicio.
...
- **Acceso completo a herramientas** — Cada bot accede al conjunto de herramientas completo de AIMTutor: recuperación RAG, ejecución de código, búsqueda web, búsqueda de artículos académicos, razonamiento profundo y lluvia de ideas.
...
```bash
aimtutor bot create math-tutor --persona "Profesor de matemáticas socrático que usa preguntas de sondeo"
aimtutor bot create writing-coach --persona "Mentor de escritura paciente y orientado a los detalles"
aimtutor bot list                  # Ver todos tus tutores activos
```

---

<a id="aimtutor-cli"></a>
### ⌨️ AIMTutor CLI — Interfaz nativa para agentes

<div align="center">
<img src="../../assets/figs/cli-architecture.png" alt="AIMTutor CLI Architecture" width="800">
</div>

AIMTutor es completamente nativo para CLI. Cada capacidad, base de conocimiento, sesión, memoria y TutorBot está a un comando de distancia — sin necesidad de navegador. La CLI sirve tanto a humanos (con renderizado enriquecido en terminal) como a agentes de IA (con salida JSON estructurada).

**Ejecución en un solo paso** — Ejecuta cualquier capacidad directamente desde el terminal:

```bash
aimtutor run chat "Explica la transformada de Fourier" -t rag --kb textbook
aimtutor run deep_solve "Demuestra que √2 es irracional" -t reason
aimtutor run deep_question "Álgebra lineal" --config num_questions=5
aimtutor run deep_research "Mecanismos de atención en transformers"
aimtutor run visualize "Dibuja la arquitectura de un transformer"
```
...
```bash
aimtutor kb create my-kb --doc textbook.pdf       # Crear desde documento
aimtutor kb add my-kb --docs-dir ./papers/         # Añadir carpeta de artículos
aimtutor kb search my-kb "descenso de gradiente"   # Buscar directamente
aimtutor kb set-default my-kb                      # Establecer como KB predeterminada
```

**Modo de salida dual**:

```bash
aimtutor run chat "Resume el capítulo 3" -f rich    # Salida formateada y coloreada
aimtutor run chat "Resume el capítulo 3" -f json    # Eventos JSON delimitados por líneas
```

**Continuidad de sesión**:

```bash
aimtutor session list                              # Listar todas las sesiones
aimtutor session open <id>                         # Reanudar en REPL
```
...
| Comando | Descripción |
|:---|:---|
| `aimtutor run <capability> <message>` | Ejecutar cualquier capacidad en un solo turno (`chat`, `deep_solve`, `deep_question`, `deep_research`, `math_animator`, `visualize`) |
| `aimtutor chat` | REPL interactivo con `--capability`, `--tool`, `--kb`, `--language` opcionales |
| `aimtutor serve` | Iniciar el servidor de API de AIMTutor |

**`aimtutor bot`**

| Comando | Descripción |
|:---|:---|
| `aimtutor bot list` | Listar todas las instancias de TutorBot |
| `aimtutor bot create <id>` | Crear e iniciar un nuevo bot (`--name`, `--persona`, `--model`) |
| `aimtutor bot start <id>` | Iniciar un bot |
| `aimtutor bot stop <id>` | Detener un bot |

**`aimtutor kb`**

| Comando | Descripción |
|:---|:---|
| `aimtutor kb list` | Listar todas las bases de conocimiento |
| `aimtutor kb info <name>` | Mostrar detalles de la base de conocimiento |
| `aimtutor kb create <name>` | Crear desde documentos (`--doc`, `--docs-dir`) |
| `aimtutor kb add <name>` | Añadir documentos incrementalmente |
| `aimtutor kb search <name> <query>` | Buscar en una base de conocimiento |
| `aimtutor kb set-default <name>` | Establecer como KB predeterminada |
| `aimtutor kb delete <name>` | Eliminar una base de conocimiento (`--force`) |

**`aimtutor memory`**

| Comando | Descripción |
|:---|:---|
| `aimtutor memory show [file]` | Ver memoria (`summary`, `profile` o `all`) |
| `aimtutor memory clear [file]` | Borrar memoria (`--force`) |

**`aimtutor session`**

| Comando | Descripción |
|:---|:---|
| `aimtutor session list` | Listar sesiones (`--limit`) |
| `aimtutor session show <id>` | Ver mensajes de la sesión |
| `aimtutor session open <id>` | Reanudar sesión en REPL |
| `aimtutor session rename <id>` | Renombrar una sesión (`--title`) |
| `aimtutor session delete <id>` | Eliminar una sesión |

**`aimtutor notebook`**

| Comando | Descripción |
|:---|:---|
| `aimtutor notebook list` | Listar notebooks |
| `aimtutor notebook create <name>` | Crear un notebook (`--description`) |
| `aimtutor notebook show <id>` | Ver registros del notebook |
| `aimtutor notebook add-md <id> <path>` | Importar markdown como registro |
| `aimtutor notebook replace-md <id> <rec> <path>` | Reemplazar un registro markdown |
| `aimtutor notebook remove-record <id> <rec>` | Eliminar un registro |

**`aimtutor book`**

| Comando | Descripción |
|:---|:---|
| `aimtutor book list` | Listar todos los libros en el espacio de trabajo |
| `aimtutor book health <book_id>` | Verificar la deriva del KB y la salud del libro |
| `aimtutor book refresh-fingerprints <book_id>` | Actualizar huellas digitales del KB y borrar páginas obsoletas |

**`aimtutor config` / `plugin` / `provider`**

| Comando | Descripción |
|:---|:---|
| `aimtutor config show` | Imprimir resumen de la configuración actual |
| `aimtutor plugin list` | Listar herramientas y capacidades registradas |
| `aimtutor plugin info <name>` | Mostrar detalles de herramienta o capacidad |
| `aimtutor provider login <provider>` | Autenticación del proveedor |
...
| `data/user/settings/system.json` | No | `aimtutor start` deriva las banderas de autenticación del frontend desde la configuración en tiempo de ejecución. |
...
AIMTutor está construido sobre los hombros de proyectos de código abierto excepcionales:

| Proyecto | Rol en AIMTutor |
|:---|:---|
...
Esperamos que AIMTutor sea un regalo para la comunidad. 🎁
...
[⭐ Danos una estrella](https://github.com/HKUDS/AIMTutor/stargazers) · [🐛 Reportar un error](https://github.com/HKUDS/AIMTutor/issues) · [💬 Discusiones](https://github.com/HKUDS/AIMTutor/discussions)
