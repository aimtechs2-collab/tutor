...
# AIMTutor: tutoria personalizada nativa para agentes

<a href="https://trendshift.io/repositories/17099" target="_blank"><img src="https://trendshift.io/api/badge/repositories/17099" alt="HKUDS%2FAIMTutor | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
...
[![GitHub release](https://img.shields.io/github/v/release/HKUDS/AIMTutor?style=flat-square&color=brightgreen)](https://github.com/HKUDS/AIMTutor/releases)
[![arXiv](https://img.shields.io/badge/arXiv-2604.26962-b31b1b?style=flat-square&logo=arxiv&logoColor=white)](https://arxiv.org/abs/2604.26962)

[![Discord](https://img.shields.io/badge/Discord-Community-5865F2?style=flat-square&logo=discord&logoColor=white)](https://discord.gg/eRsjPgMU4t)
[![Feishu](https://img.shields.io/badge/Feishu-Group-00D4AA?style=flat-square&logo=feishu&logoColor=white)](../../Communication.md)
[![WeChat](https://img.shields.io/badge/WeChat-Group-07C160?style=flat-square&logo=wechat&logoColor=white)](https://github.com/HKUDS/AIMTutor/issues/78)

[Recursos](#key-features) · [Começar](#get-started) · [Explorar](#explore-aimtutor) · [TutorBot](#tutorbot) · [CLI](#aimtutor-cli) · [Multi-usuário](#multi-user) · [Comunidade](#community)
...
>
> 🗺️ **O roteiro** é mantido aberto em [`HKUDS/AIMTutor#498`](https://github.com/HKUDS/AIMTutor/issues/498) — comente lá para votar em itens ou propor novos.

### 📦 Lançamentos

> **[2026.5.21]** [v1.4.0-beta](https://github.com/HKUDS/AIMTutor/releases/tag/v1.4.0-beta) — Workbench de Memory de três camadas (L1/L2/L3), todas as capacidades de chat reconstruídas sobre um único motor agentic, RAG só com LlamaIndex e uma superfície unificada de Settings + Capabilities.

> **[2026.5.10]** [v1.3.10](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.10) — Recuperação de CORS em Docker remoto, `DISABLE_SSL_VERIFY` em provedores SDK, citações mais seguras em blocos de código e add-on opcional Matrix E2EE.

> **[2026.5.9]** [v1.3.9](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.9) — Suporte a Zulip e NVIDIA NIM no TutorBot, roteamento mais seguro para modelos de raciocínio, `aimtutor start`, tooltips na barra lateral e paridade do store de sessões.

> **[2026.5.8]** [v1.3.8](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.8) — Implantações multiusuário opcionais com workspaces isolados por usuário, concessões de administrador, rotas de autenticação e acesso ao runtime com escopo.

<details>
<summary><b>Lançamentos anteriores (mais de 2 semanas atrás)</b></summary>

> **[2026.5.4]** [v1.3.7](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.7) — Correções de modelos de raciocínio/provedores, histórico visível do índice de Knowledge e edição de templates / limpeza do Co-Writer mais seguros.

> **[2026.5.3]** [v1.3.6](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.6) — Seleção de modelos baseada em catálogo para chat e TutorBot, reindexação RAG mais segura, correções de limite de tokens em OpenAI Responses e validação do editor de Skills.

> **[2026.5.2]** [v1.3.5](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.5) — Configurações de lançamento local mais fluidas, consultas RAG mais seguras, autenticação de embedding local mais limpa e polimento do modo escuro em Settings.

> **[2026.5.1]** [v1.3.4](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.4) — Persistência de chat em página de livro e fluxos de reconstrução, referências de chat para livro, melhor tratamento de linguagem/raciocínio e endurecimento da extração de documentos RAG.

> **[2026.4.30]** [v1.3.3](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.3) — Suporte a embeddings NVIDIA NIM + Gemini, contexto Space unificado para histórico de chat / Skills / Memory, snapshots de sessão, resiliência de reindexação RAG.

> **[2026.4.29]** [v1.3.2](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.2) — URLs transparentes de endpoint de embedding, resiliência de reindexação RAG para vetores persistidos inválidos, limpeza de Memory para saída de modelos de raciocínio, correção de runtime do Deep Solve.

> **[2026.4.28]** [v1.3.1](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.1) — Estabilidade: roteamento RAG mais seguro e validação de embedding, persistência Docker, entrada segura com IME, robustez Windows/GBK.

> **[2026.4.27]** [v1.3.0](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.0) — Índices de KB versionados com fluxo de reindexação, workspace de Knowledge reconstruído, auto-descoberta de embedding com novos adaptadores, hub Space.

> **[2026.4.25]** [v1.2.5](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.5) — Anexos de chat persistentes com gaveta de pré-visualização de arquivos, pipelines de capacidade cientes de anexos, exportação Markdown do TutorBot.

> **[2026.4.25]** [v1.2.4](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.4) — Anexos de texto/código/SVG, Setup Tour de um comando, exportação Markdown do chat, UI compacta de gestão de KB.

> **[2026.4.24]** [v1.2.3](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.3) — Anexos de documentos (PDF/DOCX/XLSX/PPTX), exibição de bloco de pensamento em raciocínio, editor de templates Soul, salvar-no-notebook a partir do Co-Writer.

> **[2026.4.22]** [v1.2.2](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.2) — Sistema de Skills criados pelo usuário, revisão de desempenho do input de chat, início automático do TutorBot, UI da Book Library, visualização em tela cheia.

> **[2026.4.21]** [v1.2.1](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.1) — Limites de tokens por etapa, Regenerar resposta em todos os pontos de entrada, correções de compatibilidade RAG e Gemma.

> **[2026.4.20]** [v1.2.0](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.0) — Compilador Book Engine de "living books", Co-Writer multidocumento, visualizações HTML interativas, menção @ ao banco de questões.

> **[2026.4.18]** [v1.1.2](https://github.com/HKUDS/AIMTutor/releases/tag/v1.1.2) — Aba Channels orientada por schema, consolidação RAG em pipeline único, prompts de chat externalizados.

> **[2026.4.17]** [v1.1.1](https://github.com/HKUDS/AIMTutor/releases/tag/v1.1.1) — "Responder agora" universal, sincronização de rolagem do Co-Writer, painel de Settings unificado, botão Stop em streaming.

> **[2026.4.15]** [v1.1.0](https://github.com/HKUDS/AIMTutor/releases/tag/v1.1.0) — Revisão de matemática LaTeX em bloco, sonda de diagnóstico LLM, guia Docker + LLM local.

> **[2026.4.14]** [v1.1.0-beta](https://github.com/HKUDS/AIMTutor/releases/tag/v1.1.0-beta) — Sessões marcáveis, tema Snow, heartbeat WebSocket e reconexão automática, revisão do registro de embeddings.

> **[2026.4.13]** [v1.0.3](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.3) — Question Notebook com favoritos e categorias, Mermaid no Visualize, detecção de incompatibilidade de embedding, compatibilidade Qwen/vLLM, suporte LM Studio e llama.cpp, e tema Glass.

> **[2026.4.11]** [v1.0.2](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.2) — Consolidação da busca com fallback SearXNG, correção da troca de provedor e correções de vazamento de recursos no frontend.

> **[2026.4.10]** [v1.0.1](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.1) — Capacidade Visualize (Chart.js/SVG), prevenção de duplicatas em quiz e suporte ao modelo o4-mini.

> **[2026.4.10]** [v1.0.0-beta.4](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.0-beta.4) — Acompanhamento de progresso de embedding com nova tentativa sob limite de taxa, correções de dependência multiplataforma e correção de validação MIME.

> **[2026.4.8]** [v1.0.0-beta.3](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.0-beta.3) — SDK nativo OpenAI/Anthropic (abandono do litellm), suporte ao Math Animator no Windows, parsing JSON robusto e i18n chinês completo.

> **[2026.4.7]** [v1.0.0-beta.2](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.0-beta.2) — Recarga a quente de configurações, saída aninhada do MinerU, correção WebSocket e Python 3.11+ como mínimo.

> **[2026.4.4]** [v1.0.0-beta.1](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.0-beta.1) — Reescrita de arquitetura nativa de agentes (~200k linhas): modelo de plugins Tools + Capabilities, CLI e SDK, TutorBot, Co-Writer, aprendizado guiado e Memory persistente.

> **[2026.1.23]** [v0.6.0](https://github.com/HKUDS/AIMTutor/releases/tag/v0.6.0) — Persistência de sessão, upload incremental de documentos, importação flexível de pipeline RAG e localização completa em chinês.

> **[2026.1.18]** [v0.5.2](https://github.com/HKUDS/AIMTutor/releases/tag/v0.5.2) — Suporte a Docling para RAG-Anything, otimização do sistema de logs e correção de bugs.

> **[2026.1.15]** [v0.5.0](https://github.com/HKUDS/AIMTutor/releases/tag/v0.5.0) — Configuração de serviço unificada, seleção de pipeline RAG por base de conhecimento, revisão da geração de questões e personalização da barra lateral.

> **[2026.1.9]** [v0.4.0](https://github.com/HKUDS/AIMTutor/releases/tag/v0.4.0) — Suporte multi-provedor LLM e embedding, nova página inicial, desacoplamento do módulo RAG e refatoração de variáveis de ambiente.

> **[2026.1.5]** [v0.3.0](https://github.com/HKUDS/AIMTutor/releases/tag/v0.3.0) — Arquitetura PromptManager unificada, CI/CD com GitHub Actions e imagens Docker pré-construídas no GHCR.

> **[2026.1.2]** [v0.2.0](https://github.com/HKUDS/AIMTutor/releases/tag/v0.2.0) — Implantação Docker, atualização para Next.js 16 e React 19, endurecimento de segurança WebSocket e correções críticas de vulnerabilidades.
...
> **[2026.4.10]** 📄 Nosso artigo já está no arXiv! Leia o [preprint](https://arxiv.org/abs/2604.26962) para saber mais sobre o desenho e as ideias por trás do AIMTutor.

> **[2026.4.4]** Há quanto tempo! ✨ O AIMTutor v1.0.0 finalmente chegou — uma evolução nativa de agentes com reescrita completa da arquitetura, TutorBot e troca flexível de modos sob a licença Apache-2.0. Um novo capítulo começa e nossa história continua!

> **[2026.2.6]** 🚀 Atingimos 10 mil estrelas em apenas 39 dias! Um enorme obrigado à nossa incrível comunidade pelo apoio!

> **[2026.1.1]** Feliz Ano Novo! Junte-se ao nosso [Discord](https://discord.gg/eRsjPgMU4t), [WeChat](https://github.com/HKUDS/AIMTutor/issues/78) ou [Discussions](https://github.com/HKUDS/AIMTutor/discussions) — vamos moldar juntos o futuro do AIMTutor!

> **[2025.12.29]** O AIMTutor é lançado oficialmente!
...
- Space — uma biblioteca pessoal de revisão que reúne histórico de chat, notebooks, banco de questões e Skills criados pelo usuário (`SKILL.md`) que trocam a persona do AIMTutor.
- Memory de três camadas — traces L1 somente-append, fatos L2 curados por superfície com citações, e síntese L3 entre superfícies. Um workbench inspecionável e um Memory Graph deixam você auditar *por que* o AIMTutor sabe o que sabe.
...
- CLI nativo para agentes — toda capacidade, KB, sessão e TutorBot está a um comando; saída rica para humanos, JSON estruturado para agentes. Entregue o [`SKILL.md`](../../SKILL.md) a qualquer LLM que use ferramentas e ele poderá operar o AIMTutor sozinho.
...
O AIMTutor agora tem quatro caminhos paralelos de instalação. Todos usam o mesmo layout de configuração em tempo de execução:

- As configurações ficam em `data/user/settings/` sob o seu workspace atual, ou sob `AIMTUTOR_HOME` / `aimtutor start --home` quando você escolher um explicitamente.
...
Para o app local completo, a ordem recomendada é **escolher um workspace → instalar → `aimtutor init` → `aimtutor start`**. `aimtutor start` pode preencher arquivos padrão ausentes como rede de segurança, mas o primeiro setup normal deve passar por `aimtutor init` para que portas e configurações de modelo fiquem explícitas antes do app Web iniciar.

### Opção 1 — Instalar o AIMTutor
...
mkdir -p my-aimtutor
cd my-aimtutor
pip install -U aimtutor
aimtutor init
aimtutor start
```

> 🧪 **Experimentando o v1.4.0 beta?** O PyPI normaliza `1.4.0-beta` para `1.4.0b0`, então `pip install -U aimtutor` continuará no último estável. Adote o pre-release com qualquer um destes:
>
> ```bash
> pip install --pre -U aimtutor      # último pre-release
> pip install -U aimtutor==1.4.0b0   # fixar exatamente em v1.4.0-beta
> ```

`aimtutor init` escreve a configuração em `data/user/settings/` no diretório onde você o executa. Ele pergunta:
...
Após `aimtutor start`, abra a URL do frontend impressa no terminal. Com as portas padrão, essa URL é [http://127.0.0.1:3782](http://127.0.0.1:3782). Se você mudou `frontend_port` durante `aimtutor init` ou editou depois `data/user/settings/system.json`, use a porta configurada.

Mantenha o terminal de `aimtutor start` aberto. Pressione `Ctrl+C` nele para parar backend e frontend.

Notas:

- `aimtutor start` inicia o backend FastAPI e o frontend Next.js empacotado juntos.
...
- Se você deliberadamente pular `aimtutor init` para um teste rápido, o app inicia com portas padrão seguras e configurações de modelo vazias; configure os modelos depois em **Settings → Models**.

### Opção 2 — Instalar a partir do código-fonte

Use isto quando estiver desenvolvendo o AIMTutor ou quiser rodar diretamente de um checkout.
Use Python 3.11+ e Node.js 22 LTS para a maior similaridade com CI e Docker.

**1. Clone o repositório**

```bash
git clone https://github.com/HKUDS/AIMTutor.git
cd AIMTutor
```
...
```bash
conda create -n aimtutor python=3.11
conda activate aimtutor
python -m pip install --upgrade pip
```
...
o modo dev do Next.js. Mantenha o terminal de `aimtutor start` aberto enquanto usar o app.
...
Se `aimtutor start` reportar um frontend existente que não responde, pare o
...
- `ghcr.io/hkuds/aimtutor:latest` — release estável
- `ghcr.io/hkuds/aimtutor:pre` — pre-release, quando disponível

```bash
docker pull ghcr.io/hkuds/aimtutor:latest
docker run --rm --name aimtutor \
  -p 127.0.0.1:3782:3782 \
  -p 127.0.0.1:8001:8001 \
  -v aimtutor-data:/app/data \
  ghcr.io/hkuds/aimtutor:latest
```

Em seguida, abra [http://127.0.0.1:3782](http://127.0.0.1:3782). Configuração, chaves de API, logs, arquivos do workspace, Memory e Knowledge Bases ficam armazenados no volume `aimtutor-data` sob `/app/data`.
...
Depois em **AIMTutor Settings → Models**, defina a URL base do provedor como `host.docker.internal`:
...
```bash
docker run -d --name aimtutor \
  -p 127.0.0.1:3782:3782 \
  -p 127.0.0.1:8001:8001 \
  -v aimtutor-data:/app/data \
  ghcr.io/hkuds/aimtutor:latest
docker logs -f aimtutor
```

Para parar uma execução Docker em primeiro plano, pressione `Ctrl+C`. Se você usou o
contêiner em background nomeado acima, execute `docker stop aimtutor`. Antes de iniciar outro contêiner
com o mesmo nome, remova o parado com `docker rm aimtutor`; o
volume `aimtutor-data` mantém suas configurações e workspace.
...
`aimtutor init --cli` usa o mesmo layout `data/user/settings/` do app completo, mas muda o comportamento do assistente:
...
- Pergunta se deve configurar embeddings, mas a resposta padrão é `No`; escolha `Yes` se planeja usar `aimtutor kb ...` ou ferramentas RAG.

Comandos comuns da CLI:

```bash
aimtutor chat
aimtutor chat --capability deep_solve --tool rag --kb my-kb
aimtutor run chat "Explain Fourier transform"
aimtutor run deep_solve "Solve x^2 = 4" --tool rag --kb my-kb
aimtutor kb create my-kb --doc textbook.pdf
aimtutor kb list
aimtutor memory show
aimtutor config show
```

A instalação local de `aimtutor-cli` não traz assets Web nem dependências de servidor.
...
aimtutor`, execute `aimtutor init` se quiser adicionar portas Web e depois execute
`aimtutor start` a partir do mesmo workspace.
...
Selecione qualquer texto e escolha **Rewrite**, **Expand** ou **Shorten** — toda ação roda como uma edição de agente rastreada que pode opcionalmente puxar de uma base de conhecimento ou da web. Co-Writer renderiza Markdown / CommonMark / GFM padrão (tabelas, código, matemática, fluxogramas, diagramas de sequência), suporta um escape via tags HTML (`<sub>`, `<sup>`, `<abbr>`, `<mark>`) e traz um template inicial ajustado para docs de produto e notas de aprendizado do AIMTutor.
...
Dê um tópico ao AIMTutor, aponte-o para sua base de conhecimento, e ele produz um livro estruturado e interativo — não uma exportação estática, mas um documento vivo que você pode ler, sobre o qual pode se autoquestionar e que pode discutir em contexto.
...
- **Skills** — Arquivos `SKILL.md` criados pelo usuário que definem personas de ensino (nome, descrição, gatilhos, corpo). Quando ativo, um Skill é injetado no system prompt do chat — transformando o AIMTutor em um tutor Socrático, um assistente de pesquisa ou qualquer papel que você projetar.
...
A Memory do AIMTutor agora é um **pipeline de três camadas** com um workbench inspecionável em `/memory`. O modelo v1 de dois arquivos `SUMMARY.md` / `PROFILE.md` foi descontinuado; tudo é migrado para o novo layout no primeiro boot.
...
- **Workspace independente** — Cada bot tem seu próprio diretório com memória, sessões, Skills e configuração separadas — totalmente isolados, ainda assim capazes de acessar a camada compartilhada de conhecimento do AIMTutor.
...
- **Acesso completo a tools** — Todo bot alcança o toolkit completo do AIMTutor: recuperação RAG, execução de código, busca web, busca acadêmica de papers, raciocínio profundo e brainstorming.
...
```bash
aimtutor bot create math-tutor --persona "Socratic math teacher who uses probing questions"
aimtutor bot create writing-coach --persona "Patient, detail-oriented writing mentor"
aimtutor bot list                  # Veja todos os seus tutores ativos
```

---

<a id="aimtutor-cli"></a>
### ⌨️ AIMTutor CLI — Interface nativa para agentes

<div align="center">
<img src="../../assets/figs/cli-architecture.png" alt="AIMTutor CLI Architecture" width="800">
</div>

O AIMTutor é totalmente nativo de CLI. Toda capability, base de conhecimento, sessão, Memory e TutorBot está a um comando — sem navegador necessário. A CLI atende tanto humanos (com renderização rica no terminal) quanto agentes de IA (com saída JSON estruturada).

Entregue o [`SKILL.md`](../../SKILL.md) na raiz do projeto a qualquer agente que use tools ([nanobot](https://github.com/HKUDS/nanobot) ou qualquer LLM com acesso a tools), e ele pode configurar e operar o AIMTutor autonomamente.

**Execução one-shot** — Rode qualquer capability direto do terminal:

```bash
aimtutor run chat "Explain the Fourier transform" -t rag --kb textbook
aimtutor run deep_solve "Prove that √2 is irrational" -t reason
aimtutor run deep_question "Linear algebra" --config num_questions=5
aimtutor run deep_research "Attention mechanisms in transformers"
aimtutor run visualize "Draw the architecture of a transformer"
```

**REPL interativo** — Uma sessão de chat persistente com troca de modo ao vivo:

```bash
aimtutor chat --capability deep_solve --kb my-kb
...
```bash
aimtutor kb create my-kb --doc textbook.pdf       # Criar a partir de documento
aimtutor kb add my-kb --docs-dir ./papers/         # Adicionar uma pasta de papers
aimtutor kb search my-kb "gradient descent"        # Buscar diretamente
aimtutor kb set-default my-kb                      # Definir como padrão para todos os comandos
```

**Modo de saída dual** — Renderização rica para humanos, JSON estruturado para pipelines:

```bash
aimtutor run chat "Summarize chapter 3" -f rich    # Saída colorida e formatada
aimtutor run chat "Summarize chapter 3" -f json    # Eventos JSON delimitados por linha
```

**Continuidade de sessão** — Retome qualquer conversa exatamente de onde parou:

```bash
aimtutor session list                              # Lista todas as sessões
aimtutor session open <id>                         # Retomar no REPL
```
...
| Command | Description |
|:---|:---|
| `aimtutor run <capability> <message>` | Executa qualquer capability em um único turno (`chat`, `deep_solve`, `deep_question`, `deep_research`, `math_animator`, `visualize`) |
| `aimtutor chat` | REPL interativo com `--capability`, `--tool`, `--kb`, `--language` opcionais |
| `aimtutor serve` | Inicia o servidor API do AIMTutor |

**`aimtutor bot`**

| Command | Description |
|:---|:---|
| `aimtutor bot list` | Lista todas as instâncias TutorBot |
| `aimtutor bot create <id>` | Cria e inicia um novo bot (`--name`, `--persona`, `--model`) |
| `aimtutor bot start <id>` | Inicia um bot |
| `aimtutor bot stop <id>` | Para um bot |

**`aimtutor kb`**

| Command | Description |
|:---|:---|
| `aimtutor kb list` | Lista todas as Knowledge Bases |
| `aimtutor kb info <name>` | Mostra detalhes da Knowledge Base |
| `aimtutor kb create <name>` | Cria a partir de documentos (`--doc`, `--docs-dir`) |
| `aimtutor kb add <name>` | Adiciona documentos incrementalmente |
| `aimtutor kb search <name> <query>` | Busca em uma Knowledge Base |
| `aimtutor kb set-default <name>` | Define como KB padrão |
| `aimtutor kb delete <name>` | Exclui uma Knowledge Base (`--force`) |

**`aimtutor memory`**

| Command | Description |
|:---|:---|
| `aimtutor memory show [file]` | Visualiza Memory (`summary`, `profile` ou `all`) |
| `aimtutor memory clear [file]` | Limpa Memory (`--force`) |

**`aimtutor session`**

| Command | Description |
|:---|:---|
| `aimtutor session list` | Lista sessões (`--limit`) |
| `aimtutor session show <id>` | Visualiza mensagens da sessão |
| `aimtutor session open <id>` | Retoma sessão no REPL |
| `aimtutor session rename <id>` | Renomeia uma sessão (`--title`) |
| `aimtutor session delete <id>` | Exclui uma sessão |

**`aimtutor notebook`**

| Command | Description |
|:---|:---|
| `aimtutor notebook list` | Lista notebooks |
| `aimtutor notebook create <name>` | Cria um notebook (`--description`) |
| `aimtutor notebook show <id>` | Visualiza registros do notebook |
| `aimtutor notebook add-md <id> <path>` | Importa markdown como registro |
| `aimtutor notebook replace-md <id> <rec> <path>` | Substitui um registro markdown |
| `aimtutor notebook remove-record <id> <rec>` | Remove um registro |

**`aimtutor book`**

| Command | Description |
|:---|:---|
| `aimtutor book list` | Lista todos os livros no workspace |
| `aimtutor book health <book_id>` | Verifica drift da KB e saúde do livro |
| `aimtutor book refresh-fingerprints <book_id>` | Atualiza fingerprints da KB e limpa páginas obsoletas |

**`aimtutor config` / `plugin` / `provider`**

| Command | Description |
|:---|:---|
| `aimtutor config show` | Imprime resumo da configuração atual |
| `aimtutor plugin list` | Lista tools e capabilities registradas |
| `aimtutor plugin info <name>` | Mostra detalhes de tool ou capability |
| `aimtutor provider login <provider>` | Auth de provedor (login OAuth `openai-codex`; `github-copilot` valida uma sessão Copilot existente) |
...
Ative a autenticação e o AIMTutor se transforma em uma implantação multi-tenant com **workspaces isolados por usuário** e **recursos curados pelo admin**. A primeira pessoa a se registrar torna-se admin e configura modelos, chaves de API e Knowledge Bases em nome de todos. As contas seguintes são criadas pelo admin (somente por convite), cada uma com seu próprio histórico de chat / Memory / notebooks / Knowledge Bases com escopo, e só veem os LLMs, KBs e Skills que o admin atribuiu a elas.
...
| `data/user/settings/system.json` | Não | `aimtutor start` deriva flags de auth do frontend e base da API a partir das configurações de runtime. |
...
O AIMTutor se apoia nos ombros de projetos open-source excelentes:

| Projeto | Papel no AIMTutor |
|:---|:---|
...
Esperamos que o AIMTutor seja um presente para a comunidade. 🎁

<a href="https://github.com/HKUDS/AIMTutor/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=HKUDS/AIMTutor&max=999" alt="Contributors" />
</a>
...
<a href="https://www.star-history.com/#HKUDS/AIMTutor&type=timeline&legend=top-left">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=HKUDS/AIMTutor&type=timeline&theme=dark&legend=top-left" />
    <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=HKUDS/AIMTutor&type=timeline&legend=top-left" />
    <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=HKUDS/AIMTutor&type=timeline&legend=top-left" />
  </picture>
</a>
...
<p align="center">
 <a href="https://www.star-history.com/hkuds/aimtutor">
  <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/badge?repo=HKUDS/AIMTutor&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/badge?repo=HKUDS/AIMTutor" />
   <img alt="Star History Rank" src="https://api.star-history.com/badge?repo=HKUDS/AIMTutor" />
  </picture>
 </a>
</p>
...
[⭐ Marque uma estrela](https://github.com/HKUDS/AIMTutor/stargazers) · [🐛 Reporte um bug](https://github.com/HKUDS/AIMTutor/issues) · [💬 Discussões](https://github.com/HKUDS/AIMTutor/discussions)
...
<p>
  <img src="https://visitor-badge.laobi.icu/badge?page_id=HKUDS.AIMTutor&style=for-the-badge&color=00d4ff" alt="Views">
</p>
