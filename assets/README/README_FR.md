...
# AIMTutor : Tutorat personnalisé natif aux agents
...
[Fonctionnalités](#key-features) · [Démarrage](#get-started) · [Découvrir](#explore-aimtutor) · [TutorBot](#tutorbot) · [CLI](#aimtutor-cli) · [Multi-utilisateur](#multi-user) · [Communauté](#community)
...
>
> 🗺️ **La feuille de route** est publique sur [`HKUDS/AIMTutor#498`](https://github.com/HKUDS/AIMTutor/issues/498) — commentez pour voter ou proposer de nouveaux éléments.

### 📦 Versions

> **[2026.5.21]** [v1.4.0-beta](https://github.com/HKUDS/AIMTutor/releases/tag/v1.4.0-beta) — Atelier Memory trois couches (L1/L2/L3), toutes les capacités de chat reconstruites sur un unique moteur agentique, RAG exclusivement sur LlamaIndex et une surface unifiée Settings + Capabilities.

> **[2026.5.10]** [v1.3.10](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.10) — Correction du CORS Docker distant, `DISABLE_SSL_VERIFY` pour les fournisseurs SDK, citations de blocs de code plus sûres et E2EE Matrix en extension optionnelle.

> **[2026.5.9]** [v1.3.9](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.9) — TutorBot avec support Zulip et NVIDIA NIM, routage des modèles de raisonnement plus sûr, `aimtutor start`, infobulles de la barre latérale et parité du stockage de sessions.

> **[2026.5.8]** [v1.3.8](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.8) — Déploiements multi-utilisateurs optionnels avec espaces de travail isolés, droits admin, routes d'authentification et accès runtime à portée limitée.

<details>
<summary><b>Versions précédentes (plus de 2 semaines)</b></summary>

> **[2026.5.4]** [v1.3.7](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.7) — Correctifs modèles de raisonnement/fournisseurs, historique d'index Knowledge visible, vidage Co-Writer et édition de modèles plus sûrs.

> **[2026.5.3]** [v1.3.6](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.6) — Sélection de modèles par catalogue (chat et TutorBot), réindexation RAG plus sûre, plafonds de tokens OpenAI Responses, validation de l'éditeur Skills.

> **[2026.5.2]** [v1.3.5](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.5) — Paramètres de lancement locaux plus fluides, requêtes RAG plus sûres, auth embeddings locale clarifiée, mode sombre des réglages peaufiné.

> **[2026.5.1]** [v1.3.4](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.4) — Persistance du chat sur les pages livre et flux de reconstruction, références chat→livre, langage/raisonnement renforcés, extraction RAG durcie.

> **[2026.4.30]** [v1.3.3](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.3) — Embeddings NVIDIA NIM et Gemini, contexte Space unifié (historique chat/skills/mémoire), instantanés de session, résilience de réindexation RAG.

> **[2026.4.29]** [v1.3.2](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.2) — URLs d'embedding visibles, réindexation si vecteurs invalides, nettoyage mémoire pour sortie thinking, correctif Deep Solve.

> **[2026.4.28]** [v1.3.1](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.1) — Stabilité : routage RAG et validation embeddings, persistance Docker, saisie IME, robustesse Windows/GBK.

> **[2026.4.27]** [v1.3.0](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.0) — Index KB versionnés et flux de réindexation, espace connaissances refait, auto-détection d'embeddings et nouveaux adaptateurs, hub Space.

> **[2026.4.25]** [v1.2.5](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.5) — Pièces jointes persistantes et tiroir d'aperçu, pipelines sensibles aux PJ, export Markdown TutorBot.

> **[2026.4.25]** [v1.2.4](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.4) — PJ texte/code/SVG, Setup Tour en une commande, export Markdown du chat, UI KB compacte.

> **[2026.4.24]** [v1.2.3](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.3) — PJ documents, blocs de raisonnement, éditeur de modèles Soul, Co-Writer vers carnet.

> **[2026.4.22]** [v1.2.2](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.2) — Skills utilisateur, perf. saisie chat, démarrage auto TutorBot, UI bibliothèque, plein écran visualisation.

> **[2026.4.21]** [v1.2.1](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.1) — Plafonds tokens par étape, régénérer partout, compatibilité RAG & Gemma.

> **[2026.4.20]** [v1.2.0](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.0) — Compilateur Book Engine « livre vivant », Co-Writer multi-documents, HTML interactif, @ dans la banque de questions.

> **[2026.4.18]** [v1.1.2](https://github.com/HKUDS/AIMTutor/releases/tag/v1.1.2) — Onglet Channels piloté par schéma, pipeline RAG unique, prompts externalisés.

> **[2026.4.17]** [v1.1.1](https://github.com/HKUDS/AIMTutor/releases/tag/v1.1.1) — « Répondre maintenant » universel, sync défilement Co-Writer, panneau réglages unifié, bouton Stop streaming.

> **[2026.4.15]** [v1.1.0](https://github.com/HKUDS/AIMTutor/releases/tag/v1.1.0) — Blocs LaTeX, sonde diagnostic LLM, guide Docker & LLM local.

> **[2026.4.14]** [v1.1.0-beta](https://github.com/HKUDS/AIMTutor/releases/tag/v1.1.0-beta) — Sessions URL, thème Snow, heartbeat WebSocket et reconnexion auto, registre d'embeddings refondu.

> **[2026.4.13]** [v1.0.3](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.3) — Carnet de questions avec marque-pages, Mermaid dans Visualize, détection mismatch embeddings, Qwen/vLLM, LM Studio & llama.cpp, thème Glass.

> **[2026.4.11]** [v1.0.2](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.2) — Recherche unifiée + SearXNG, correctif changement fournisseur, fuites ressources frontend.

> **[2026.4.10]** [v1.0.1](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.1) — Visualize (Chart.js/SVG), anti-doublons quiz, o4-mini.

> **[2026.4.10]** [v1.0.0-beta.4](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.0-beta.4) — Suivi progression embeddings avec retry limite de débit, correctifs dépendances multiplateforme, validation MIME.

> **[2026.4.8]** [v1.0.0-beta.3](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.0-beta.3) — SDK natif OpenAI/Anthropic (suppression litellm), animateur math Windows, parsing JSON robuste, i18n chinois complet.

> **[2026.4.7]** [v1.0.0-beta.2](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.0-beta.2) — Rechargement à chaud des réglages, sortie imbriquée MinerU, correctif WebSocket, Python 3.11+ minimum.

> **[2026.4.4]** [v1.0.0-beta.1](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.0-beta.1) — Réécriture architecture native agentique (~200k lignes) : modèle de plugins Tools + Capabilities, CLI & SDK, TutorBot, Co-Writer, Apprentissage guidé et mémoire persistante.

> **[2026.1.23]** [v0.6.0](https://github.com/HKUDS/AIMTutor/releases/tag/v0.6.0) — Persistance de session, upload incrémental, import pipeline RAG flexible, localisation chinoise complète.

> **[2026.1.18]** [v0.5.2](https://github.com/HKUDS/AIMTutor/releases/tag/v0.5.2) — Support Docling pour RAG-Anything, optimisation logging, corrections de bugs.

> **[2026.1.15]** [v0.5.0](https://github.com/HKUDS/AIMTutor/releases/tag/v0.5.0) — Configuration unifiée des services, sélection pipeline RAG par KB, refonte génération de questions, personnalisation barre latérale.

> **[2026.1.9]** [v0.4.0](https://github.com/HKUDS/AIMTutor/releases/tag/v0.4.0) — Support multi-fournisseur LLM & embeddings, nouvelle page d'accueil, découplage module RAG, refactorisation variables d'environnement.

> **[2026.1.5]** [v0.3.0](https://github.com/HKUDS/AIMTutor/releases/tag/v0.3.0) — Architecture PromptManager unifiée, CI/CD GitHub Actions, images Docker préconstruites sur GHCR.

> **[2026.1.2]** [v0.2.0](https://github.com/HKUDS/AIMTutor/releases/tag/v0.2.0) — Docker, Next.js 16 & React 19, sécurisation WebSocket, corrections de vulnérabilités critiques.
...
> **[2026.4.10]** 📄 Notre article est maintenant sur arXiv ! Lisez le [preprint](https://arxiv.org/abs/2604.26962) pour en savoir plus sur la conception et les idées derrière AIMTutor.

> **[2026.4.4]** Longtemps sans nouvelles ! ✨ AIMTutor v1.0.0 est enfin là — une évolution native aux agents avec une réécriture complète de l'architecture, TutorBot et un changement de mode flexible sous licence Apache-2.0. Un nouveau chapitre commence !

> **[2026.2.6]** 🚀 Nous avons atteint 10k étoiles en seulement 39 jours ! Un immense merci à notre incroyable communauté !

> **[2026.1.1]** Bonne année ! Rejoignez notre [Discord](https://discord.gg/eRsjPgMU4t), [WeChat](https://github.com/HKUDS/AIMTutor/issues/78) ou [Discussions](https://github.com/HKUDS/AIMTutor/discussions) — construisons ensemble l'avenir de AIMTutor !

> **[2025.12.29]** AIMTutor est officiellement lancé !
...
- Space — une bibliothèque personnelle de révision regroupant l'historique des chats, les carnets, la banque de questions et les skills créés par l'utilisateur (`SKILL.md`) qui changent la personnalité de AIMTutor.
- Mémoire à trois couches — traces L1 en ajout seul, faits L2 organisés par surface avec citations et synthèse L3 entre surfaces. Un atelier inspectable et un graphe de mémoire vous permettent d'auditer *pourquoi* AIMTutor sait ce qu'il sait.
...
- CLI native aux agents — chaque capacité, KB, session et TutorBot est accessible en une commande ; sortie enrichie pour les humains, JSON structuré pour les agents. Donnez le [`SKILL.md`](../../SKILL.md) à n'importe quel LLM avec accès aux outils et il peut piloter AIMTutor de manière autonome.
...
AIMTutor propose désormais quatre chemins d'installation parallèles. Tous utilisent le même schéma de configuration d'exécution :

- Les réglages résident dans `data/user/settings/` sous votre espace de travail actuel, ou sous `AIMTUTOR_HOME` / `aimtutor start --home` quand vous en choisissez un explicitement.
...
Pour l'application locale complète, l'ordre recommandé est **choisir un espace de travail → installer → `aimtutor init` → `aimtutor start`**.

### Option 1 — Installer AIMTutor
...
> 🧪 **Vous essayez la bêta v1.4.0 ?** PyPI normalise `1.4.0-beta` en `1.4.0b0`, donc `pip install -U aimtutor` restera sur la dernière version stable. Optez pour la pré-version avec :
>
> ```bash
> pip install --pre -U aimtutor      # dernière pré-version
> pip install -U aimtutor==1.4.0b0   # épingler exactement à v1.4.0-beta
> ```

`aimtutor init` écrit la configuration dans `data/user/settings/` dans le répertoire où vous l'exécutez. Il vous demande :
...
Après `aimtutor start`, ouvrez l'URL du frontend affichée dans le terminal. Avec les ports par défaut, cette URL est [http://127.0.0.1:3782](http://127.0.0.1:3782).

Gardez le terminal `aimtutor start` ouvert. Appuyez sur `Ctrl+C` dans ce terminal pour arrêter le backend et le frontend.

Notes :

- `aimtutor start` lance le backend FastAPI et le frontend Next.js packagé ensemble.
- L'application web packagée ne nécessite ni `git clone` ni `npm install`, mais a besoin d'un runtime Node.js 20+ local.
- Si vous sautez délibérément `aimtutor init` pour un essai rapide, l'application démarre avec des ports sécurisés par défaut et des réglages de modèles vides ; configurez les modèles ensuite dans **Settings → Models**.

### Option 2 — Installation depuis les sources

À utiliser quand vous développez AIMTutor ou souhaitez l'exécuter directement depuis un checkout.
...
Si `aimtutor start` signale un frontend existant qui ne répond pas, supprimez les fichiers de verrou obsolètes et redémarrez :
...
- `ghcr.io/hkuds/aimtutor:latest` — version stable
- `ghcr.io/hkuds/aimtutor:pre` — pré-version, quand disponible
...
Ouvrez ensuite [http://127.0.0.1:3782](http://127.0.0.1:3782). La configuration, les clés API, les logs, les fichiers de l'espace de travail, la mémoire et les bases de connaissances sont stockés dans le volume `aimtutor-data` sous `/app/data`.
...
Puis dans **AIMTutor Settings → Models**, définissez l'URL de base du fournisseur sur `host.docker.internal` :
...
`aimtutor init --cli` utilise le même schéma `data/user/settings/` que l'application complète, mais modifie le comportement de l'assistant :
...
- Demande si configurer les embeddings, mais la réponse par défaut est `Non` ; choisissez `Oui` si vous prévoyez d'utiliser `aimtutor kb ...` ou les outils RAG.
...
aimtutor run chat "Expliquer la transformée de Fourier"
aimtutor run deep_solve "Résoudre x^2 = 4" --tool rag --kb my-kb
...
Donnez un sujet à AIMTutor, pointez-le vers votre base de connaissances, et il produit un livre structuré et interactif — pas une exportation statique, mais un document vivant que vous pouvez lire, sur lequel vous interroger et discuter en contexte.
...
La mémoire de AIMTutor est désormais un **pipeline à trois couches** avec un atelier inspectable à `/memory`.
...
- **Accès complet aux outils** — Chaque bot accède à la boîte à outils complète de AIMTutor : récupération RAG, exécution de code, recherche web, recherche d'articles académiques, raisonnement profond et brainstorming.
...
```bash
aimtutor bot create math-tutor --persona "Professeur de maths socratique qui pose des questions stimulantes"
aimtutor bot create writing-coach --persona "Mentor d'écriture patient et orienté détails"
aimtutor bot list                  # Voir tous vos tuteurs actifs
```

---

<a id="aimtutor-cli"></a>
### ⌨️ AIMTutor CLI — Interface native aux agents

<div align="center">
<img src="../../assets/figs/cli-architecture.png" alt="AIMTutor CLI Architecture" width="800">
</div>

AIMTutor est entièrement natif pour la CLI. Chaque capacité, base de connaissances, session, mémoire et TutorBot est accessible en une commande — sans navigateur nécessaire.

**Exécution en une seule commande** :

```bash
aimtutor run chat "Expliquer la transformée de Fourier" -t rag --kb textbook
aimtutor run deep_solve "Prouver que √2 est irrationnel" -t reason
aimtutor run deep_question "Algèbre linéaire" --config num_questions=5
aimtutor run deep_research "Mécanismes d'attention dans les transformers"
aimtutor run visualize "Dessiner l'architecture d'un transformer"
```
...
aimtutor kb search my-kb "descente de gradient"
...
```bash
aimtutor run chat "Résumer le chapitre 3" -f rich    # Sortie colorée et formatée
aimtutor run chat "Résumer le chapitre 3" -f json    # Événements JSON délimités par ligne
```
...
|:---|:---|
| `aimtutor run <capability> <message>` | Exécuter n'importe quelle capacité en un seul tour (`chat`, `deep_solve`, `deep_question`, `deep_research`, `math_animator`, `visualize`) |
| `aimtutor chat` | REPL interactif avec `--capability`, `--tool`, `--kb`, `--language` optionnels |
| `aimtutor serve` | Démarrer le serveur API AIMTutor |

**`aimtutor bot`**

| Commande | Description |
|:---|:---|
| `aimtutor bot list` | Lister toutes les instances TutorBot |
| `aimtutor bot create <id>` | Créer et démarrer un nouveau bot (`--name`, `--persona`, `--model`) |
| `aimtutor bot start <id>` | Démarrer un bot |
| `aimtutor bot stop <id>` | Arrêter un bot |

**`aimtutor kb`**

| Commande | Description |
|:---|:---|
| `aimtutor kb list` | Lister toutes les bases de connaissances |
| `aimtutor kb info <name>` | Afficher les détails de la base de connaissances |
| `aimtutor kb create <name>` | Créer depuis des documents (`--doc`, `--docs-dir`) |
| `aimtutor kb add <name>` | Ajouter des documents de manière incrémentale |
| `aimtutor kb search <name> <query>` | Rechercher dans une base de connaissances |
| `aimtutor kb set-default <name>` | Définir comme KB par défaut |
| `aimtutor kb delete <name>` | Supprimer une base de connaissances (`--force`) |

**`aimtutor memory`**

| Commande | Description |
|:---|:---|
| `aimtutor memory show [file]` | Voir la mémoire (`summary`, `profile` ou `all`) |
| `aimtutor memory clear [file]` | Effacer la mémoire (`--force`) |

**`aimtutor session`**

| Commande | Description |
|:---|:---|
| `aimtutor session list` | Lister les sessions (`--limit`) |
| `aimtutor session show <id>` | Voir les messages de la session |
| `aimtutor session open <id>` | Reprendre la session dans le REPL |
| `aimtutor session rename <id>` | Renommer une session (`--title`) |
| `aimtutor session delete <id>` | Supprimer une session |

**`aimtutor notebook`**

| Commande | Description |
|:---|:---|
| `aimtutor notebook list` | Lister les carnets |
| `aimtutor notebook create <name>` | Créer un carnet (`--description`) |
| `aimtutor notebook show <id>` | Voir les enregistrements du carnet |
| `aimtutor notebook add-md <id> <path>` | Importer markdown comme enregistrement |
| `aimtutor notebook replace-md <id> <rec> <path>` | Remplacer un enregistrement markdown |
| `aimtutor notebook remove-record <id> <rec>` | Supprimer un enregistrement |

**`aimtutor book`**

| Commande | Description |
|:---|:---|
| `aimtutor book list` | Lister tous les livres dans l'espace de travail |
| `aimtutor book health <book_id>` | Vérifier la dérive KB et la santé du livre |
| `aimtutor book refresh-fingerprints <book_id>` | Actualiser les empreintes KB et effacer les pages obsolètes |

**`aimtutor config` / `plugin` / `provider`**

| Commande | Description |
|:---|:---|
| `aimtutor config show` | Afficher le résumé de la configuration actuelle |
| `aimtutor plugin list` | Lister les outils et capacités enregistrés |
| `aimtutor plugin info <name>` | Afficher les détails d'un outil ou d'une capacité |
| `aimtutor provider login <provider>` | Authentification du fournisseur |
...
Activez l'authentification et AIMTutor devient un déploiement multi-tenant avec **espaces de travail isolés par utilisateur** et **ressources gérées par l'administrateur**.
...
| `data/user/settings/system.json` | Non | `aimtutor start` dérive les indicateurs d'auth du frontend depuis les réglages d'exécution. |
...
AIMTutor est construit sur les épaules de projets open source remarquables :

| Projet | Rôle dans AIMTutor |
|:---|:---|
...
Nous espérons que AIMTutor sera un cadeau pour la communauté. 🎁
...
[⭐ Nous donner une étoile](https://github.com/HKUDS/AIMTutor/stargazers) · [🐛 Signaler un bug](https://github.com/HKUDS/AIMTutor/issues) · [💬 Discussions](https://github.com/HKUDS/AIMTutor/discussions)
