...
# AIMTutor: Spersonalizowane korepetycje natywne dla agentów
...
[Funkcje](#key-features) · [Jak zacząć](#get-started) · [Odkrywaj](#explore-aimtutor) · [TutorBot](#tutorbot) · [CLI](#aimtutor-cli) · [Multi-użytkownik](#multi-user) · [Społeczność](#community)
...
>
> 🗺️ **Roadmapa** prowadzona jest jawnie pod adresem [`HKUDS/AIMTutor#498`](https://github.com/HKUDS/AIMTutor/issues/498) — komentuj, aby głosować na elementy lub proponować nowe.

### 📦 Wydania

> **[2026.5.21]** [v1.4.0-beta](https://github.com/HKUDS/AIMTutor/releases/tag/v1.4.0-beta) — Trójwarstwowy workbench Memory (L1/L2/L3), każda funkcja czatu przebudowana w oparciu o jeden agentowy silnik, RAG wyłącznie na LlamaIndex oraz zunifikowana powierzchnia Settings + Capabilities.

> **[2026.5.10]** [v1.3.10](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.10) — Naprawa CORS dla zdalnego Dockera, `DISABLE_SSL_VERIFY` w dostawcach SDK, bezpieczniejsze cytaty w blokach kodu oraz opcjonalny dodatek Matrix E2EE.

> **[2026.5.9]** [v1.3.9](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.9) — Wsparcie Zulip i NVIDIA NIM w TutorBot, bezpieczniejszy routing modeli rozumujących, `aimtutor start`, podpowiedzi w pasku bocznym i spójność magazynu sesji.

> **[2026.5.8]** [v1.3.8](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.8) — Opcjonalne wdrożenia wielu użytkowników z izolowanymi przestrzeniami roboczymi, uprawnienia administratora, trasy uwierzytelniania oraz ograniczony dostęp w trakcie działania.

<details>
<summary><b>Starsze wydania (ponad 2 tygodnie temu)</b></summary>

> **[2026.5.4]** [v1.3.7](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.7) — Poprawki dla modeli/dostawców rozumujących, widoczna historia indeksów Knowledge oraz bezpieczniejsze czyszczenie i edycja szablonów w Co-Writer.

> **[2026.5.3]** [v1.3.6](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.6) — Wybór modeli na podstawie katalogu dla czatu i TutorBot, bezpieczniejsza ponowna indeksacja RAG, poprawki limitów tokenów OpenAI Responses oraz walidacja edytora Skills.

> **[2026.5.2]** [v1.3.5](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.5) — Płynniejsze ustawienia lokalnego uruchamiania, bezpieczniejsze zapytania RAG, schludniejsze uwierzytelnianie lokalnych embeddingów oraz dopracowanie trybu ciemnego w Settings.

> **[2026.5.1]** [v1.3.4](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.4) — Trwałość czatu na stronach książek i przepływy odbudowy, odniesienia z czatu do książek, lepsza obsługa języka i rozumowania, wzmocnienie ekstrakcji dokumentów RAG.

> **[2026.4.30]** [v1.3.3](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.3) — Wsparcie embeddingów NVIDIA NIM i Gemini, zunifikowany kontekst Space dla historii czatu/skills/memory, migawki sesji oraz odporność na ponowną indeksację RAG.

> **[2026.4.29]** [v1.3.2](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.2) — Przejrzyste adresy URL endpointów embeddingów, odporność ponownej indeksacji RAG przy nieprawidłowych zapisanych wektorach, sprzątanie pamięci dla wyjścia modeli rozumujących oraz poprawka działania Deep Solve.

> **[2026.4.28]** [v1.3.1](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.1) — Stabilność: bezpieczniejszy routing RAG oraz walidacja embeddingów, trwałość Docker, bezpieczne wejście IME, odporność na Windows/GBK.

> **[2026.4.27]** [v1.3.0](https://github.com/HKUDS/AIMTutor/releases/tag/v1.3.0) — Wersjonowane indeksy KB z procesem ponownej indeksacji, przebudowana przestrzeń Knowledge, automatyczne wykrywanie embeddingów z nowymi adapterami oraz hub Space.

> **[2026.4.25]** [v1.2.5](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.5) — Trwałe załączniki czatu z szufladą podglądu plików, potoki funkcji świadome załączników oraz eksport Markdown w TutorBot.

> **[2026.4.25]** [v1.2.4](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.4) — Załączniki tekstowe/kodu/SVG, Setup Tour jednym poleceniem, eksport czatu do Markdown, kompaktowy interfejs zarządzania KB.

> **[2026.4.24]** [v1.2.3](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.3) — Załączniki dokumentów (PDF/DOCX/XLSX/PPTX), wyświetlanie bloku rozumowania, edytor szablonów Soul, zapis Co-Writer do notatnika.

> **[2026.4.22]** [v1.2.2](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.2) — System Skills tworzonych przez użytkownika, gruntowna poprawa wydajności wprowadzania w czacie, automatyczny start TutorBot, interfejs Book Library, wizualizacje w trybie pełnoekranowym.

> **[2026.4.21]** [v1.2.1](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.1) — Limity tokenów na etap, regeneracja odpowiedzi we wszystkich punktach wejścia, poprawki kompatybilności RAG i Gemma.

> **[2026.4.20]** [v1.2.0](https://github.com/HKUDS/AIMTutor/releases/tag/v1.2.0) — Kompilator „żywych książek” Book Engine, wielodokumentowy Co-Writer, interaktywne wizualizacje HTML, @-wzmianki Question Bank.

> **[2026.4.18]** [v1.1.2](https://github.com/HKUDS/AIMTutor/releases/tag/v1.1.2) — Zakładka Channels oparta na schemacie, konsolidacja RAG w jeden potok, zewnętrzne prompty czatu.

> **[2026.4.17]** [v1.1.1](https://github.com/HKUDS/AIMTutor/releases/tag/v1.1.1) — Uniwersalne „Odpowiedz teraz”, synchronizacja przewijania Co-Writer, zunifikowany panel ustawień, przycisk Stop dla streamingu.

> **[2026.4.15]** [v1.1.0](https://github.com/HKUDS/AIMTutor/releases/tag/v1.1.0) — Przebudowa blokowej matematyki LaTeX, sonda diagnostyczna LLM, wskazówki dla Docker + lokalnego LLM.

> **[2026.4.14]** [v1.1.0-beta](https://github.com/HKUDS/AIMTutor/releases/tag/v1.1.0-beta) — Sesje z zakładkami, motyw Snow, heartbeat WebSocket i automatyczne ponowne łączenie, przebudowa rejestru embeddingów.

> **[2026.4.13]** [v1.0.3](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.3) — Notatnik pytań z zakładkami i kategoriami, Mermaid w Visualize, wykrywanie niedopasowania embeddingów, kompatybilność Qwen/vLLM, wsparcie LM Studio i llama.cpp oraz motyw Glass.

> **[2026.4.11]** [v1.0.2](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.2) — Konsolidacja wyszukiwania z fallbackiem do SearXNG, naprawa przełączania dostawców i poprawki wycieków zasobów we frontendzie.

> **[2026.4.10]** [v1.0.1](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.1) — Funkcja Visualize (Chart.js/SVG), zapobieganie duplikatom w quizach oraz wsparcie modelu o4-mini.

> **[2026.4.10]** [v1.0.0-beta.4](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.0-beta.4) — Śledzenie postępu embeddingów z ponawianiem przy rate-limit, międzyplatformowe poprawki zależności oraz naprawa walidacji MIME.

> **[2026.4.8]** [v1.0.0-beta.3](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.0-beta.3) — Natywne SDK OpenAI/Anthropic (rezygnacja z litellm), wsparcie Math Animator dla Windows, odporne parsowanie JSON oraz pełna chińska i18n.

> **[2026.4.7]** [v1.0.0-beta.2](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.0-beta.2) — Przeładowywanie ustawień na gorąco, zagnieżdżone wyjście MinerU, poprawka WebSocket oraz minimum Python 3.11+.

> **[2026.4.4]** [v1.0.0-beta.1](https://github.com/HKUDS/AIMTutor/releases/tag/v1.0.0-beta.1) — Przepisanie architektury natywnej dla agentów (~200 tys. linii): model wtyczek Tools + Capabilities, CLI i SDK, TutorBot, Co-Writer, Guided Learning oraz trwała pamięć.

> **[2026.1.23]** [v0.6.0](https://github.com/HKUDS/AIMTutor/releases/tag/v0.6.0) — Trwałość sesji, przyrostowe przesyłanie dokumentów, elastyczny import potoku RAG i pełna lokalizacja chińska.

> **[2026.1.18]** [v0.5.2](https://github.com/HKUDS/AIMTutor/releases/tag/v0.5.2) — Wsparcie Docling dla RAG-Anything, optymalizacja systemu logowania oraz poprawki błędów.

> **[2026.1.15]** [v0.5.0](https://github.com/HKUDS/AIMTutor/releases/tag/v0.5.0) — Zunifikowana konfiguracja usług, wybór potoku RAG dla każdej bazy wiedzy, przebudowa generowania pytań oraz personalizacja paska bocznego.

> **[2026.1.9]** [v0.4.0](https://github.com/HKUDS/AIMTutor/releases/tag/v0.4.0) — Wsparcie wielu dostawców LLM i embeddingów, nowa strona główna, oddzielenie modułu RAG oraz refaktor zmiennych środowiskowych.

> **[2026.1.5]** [v0.3.0](https://github.com/HKUDS/AIMTutor/releases/tag/v0.3.0) — Zunifikowana architektura PromptManager, CI/CD oparte na GitHub Actions oraz gotowe obrazy Docker na GHCR.

> **[2026.1.2]** [v0.2.0](https://github.com/HKUDS/AIMTutor/releases/tag/v0.2.0) — Wdrożenie Docker, aktualizacja Next.js 16 i React 19, wzmocnienie bezpieczeństwa WebSocket oraz krytyczne poprawki luk.
...
> **[2026.4.10]** 📄 Nasz artykuł jest już dostępny na arXiv! Przeczytaj [preprint](https://arxiv.org/abs/2604.26962), aby dowiedzieć się więcej o projekcie i ideach stojących za AIMTutor.

> **[2026.4.4]** Dawno się nie widzieliśmy! ✨ AIMTutor v1.0.0 jest wreszcie tutaj — agentowa ewolucja z przebudowaną od podstaw architekturą, TutorBot oraz elastycznym przełączaniem trybów na licencji Apache-2.0. Zaczyna się nowy rozdział, a nasza historia trwa dalej!
...
> **[2026.1.1]** Szczęśliwego Nowego Roku! Dołącz do naszego [Discorda](https://discord.gg/eRsjPgMU4t), [WeChat](https://github.com/HKUDS/AIMTutor/issues/78) lub [Dyskusji](https://github.com/HKUDS/AIMTutor/discussions) — wspólnie kształtujmy przyszłość AIMTutor!

> **[2025.12.29]** AIMTutor zostaje oficjalnie wydany!
...
- Space — osobista biblioteka powtórek łącząca historię czatu, notatniki, bank pytań oraz Skills tworzone przez użytkownika (`SKILL.md`), które zmieniają personę AIMTutor.
- Trójwarstwowa Memory — append-only ślady L1, kurowane fakty per-powierzchnia L2 z cytatami oraz synteza międzypowierzchniowa L3. Inspektowalny workbench i Memory Graph pozwalają audytować, *dlaczego* AIMTutor wie to, co wie.
...
- CLI natywne dla agentów — każda funkcja, KB, sesja oraz TutorBot dostępne jednym poleceniem; bogate wyjście dla ludzi, ustrukturyzowany JSON dla agentów. Przekaż dowolnemu LLM-owi z narzędziami plik [`SKILL.md`](../../SKILL.md) i sam pokieruje AIMTutor.
...
AIMTutor ma teraz cztery równoległe ścieżki instalacji. Wszystkie korzystają z tego samego układu konfiguracji runtime:

- Ustawienia żyją w `data/user/settings/` w bieżącej przestrzeni roboczej lub pod `AIMTUTOR_HOME` / `aimtutor start --home`, jeśli wybierzesz jedną wprost.
...
Dla pełnej aplikacji lokalnej zalecana kolejność to **wybierz workspace → zainstaluj → `aimtutor init` → `aimtutor start`**. `aimtutor start` może uzupełnić brakujące domyślne pliki jako siatka bezpieczeństwa, ale normalna konfiguracja pierwszego uruchomienia powinna iść przez `aimtutor init`, aby porty i ustawienia modeli były jawne przed startem aplikacji webowej.

### Opcja 1 — Zainstaluj AIMTutor
...
> 🧪 **Próbujesz wersji v1.4.0 beta?** PyPI normalizuje `1.4.0-beta` do `1.4.0b0`, więc `pip install -U aimtutor` pozostanie na najnowszej wersji stabilnej. Włącz pre-release za pomocą jednego z:
>
> ```bash
> pip install --pre -U aimtutor      # najnowsze pre-release
> pip install -U aimtutor==1.4.0b0   # przypnij dokładnie do v1.4.0-beta
> ```

`aimtutor init` zapisuje konfigurację pod `data/user/settings/` w katalogu, w którym to uruchamiasz. Pyta o:
...
Po `aimtutor start` otwórz adres frontendu wypisany w terminalu. Z domyślnymi portami jest to [http://127.0.0.1:3782](http://127.0.0.1:3782). Jeśli zmieniłeś `frontend_port` podczas `aimtutor init` lub później edytowałeś `data/user/settings/system.json`, użyj tego skonfigurowanego portu.

Pozostaw terminal `aimtutor start` otwarty. Naciśnij `Ctrl+C` w tym terminalu, aby zatrzymać backend i frontend.

Uwagi:

- `aimtutor start` uruchamia razem backend FastAPI oraz spakowany frontend Next.js.
...
- Jeśli świadomie pominiesz `aimtutor init` dla szybkiego testu, aplikacja startuje z bezpiecznymi domyślnymi portami i pustymi ustawieniami modeli; skonfiguruj modele później w **Settings → Models**.

### Opcja 2 — Instalacja ze źródeł

Użyj tej opcji, gdy rozwijasz AIMTutor lub chcesz uruchomić bezpośrednio z checkoutu.
...
w trybie deweloperskim Next.js. Pozostaw terminal `aimtutor start` otwarty podczas
...
Jeśli `aimtutor start` zgłosi istniejący frontend, który nie odpowiada, zatrzymaj
...
- `ghcr.io/hkuds/aimtutor:latest` — stabilne wydanie
- `ghcr.io/hkuds/aimtutor:pre` — pre-release, gdy dostępne
...
Następnie otwórz [http://127.0.0.1:3782](http://127.0.0.1:3782). Konfiguracja, klucze API, logi, pliki workspace, pamięć oraz bazy wiedzy są przechowywane w wolumenie `aimtutor-data` pod `/app/data`.
...
Następnie w **AIMTutor Settings → Models** ustaw Base URL dostawcy na `host.docker.internal`:
...
kontenera powyżej, uruchom `docker stop aimtutor`. Przed uruchomieniem kolejnego kontenera
o tej samej nazwie usuń zatrzymany za pomocą `docker rm aimtutor`; wolumen
`aimtutor-data` zachowuje Twoje ustawienia i workspace.
...
`aimtutor init --cli` używa tego samego układu `data/user/settings/` co pełna aplikacja, ale zmienia zachowanie kreatora:
...
- Pyta, czy skonfigurować embeddingi, ale domyślna odpowiedź to `No`; wybierz `Yes`, jeśli planujesz używać `aimtutor kb ...` lub narzędzi RAG.
...
Lokalna instalacja `aimtutor-cli` nie dostarcza zasobów webowych ani zależności serwera.
...
aimtutor`, uruchom `aimtutor init`, jeśli chcesz dodać porty webowe, a następnie uruchom
`aimtutor start` z tej samej przestrzeni roboczej.
...
Daj AIMTutor temat, wskaż mu Twoją bazę wiedzy, a wyprodukuje strukturalną, interaktywną książkę — nie statyczny eksport, lecz żywy dokument, który możesz czytać, samodzielnie odpytywać i omawiać w kontekście.
...
Strony są składane z 13 typów bloków — tekst, callout, quiz, fiszki, kod, rysunek, deep dive, animacja, demo interaktywne (teraz włącznie z **GeoGebra viewer**), oś czasu, graf pojęć, sekcja i notatka użytkownika — każdy renderowany ze swoim własnym komponentem interaktywnym. Strony książki są oznaczone odciskami palców względem ich źródłowego KB; `aimtutor book health` raportuje dryf, a `aimtutor book refresh-fingerprints` czyści przestarzałe strony, gdy źródła się zmieniają.
...
- **Skills** — Pliki `SKILL.md` tworzone przez użytkownika, które definiują persony nauczania (nazwa, opis, wyzwalacze, treść). Gdy aktywne, skill jest wstrzykiwany w system prompt czatu — zamieniając AIMTutor w sokratejskiego tutora, asystenta badawczego lub dowolną rolę, którą zaprojektujesz.
...
Memory AIMTutor jest teraz **trójwarstwowym potokiem** z inspektowalnym workbenchem pod `/memory`. Dwuplikowy model v1 `SUMMARY.md` / `PROFILE.md` zniknął; wszystko jest migrowane do nowego układu przy pierwszym starcie.
...
- **Niezależny workspace** — Każdy bot ma własny katalog z oddzielną pamięcią, sesjami, Skills i konfiguracją — w pełni izolowany, ale zdolny do dostępu do współdzielonej warstwy wiedzy AIMTutor.
...
- **Pełny dostęp do narzędzi** — Każdy bot sięga do kompletnego zestawu narzędzi AIMTutor: pobieranie RAG, wykonanie kodu, wyszukiwanie webowe, wyszukiwanie artykułów akademickich, głębokie rozumowanie i brainstorming.
...
aimtutor bot list                  # Zobacz wszystkich aktywnych tutorów
```

---

<a id="aimtutor-cli"></a>
### ⌨️ AIMTutor CLI — Interfejs natywny dla agentów

<div align="center">
<img src="../../assets/figs/cli-architecture.png" alt="AIMTutor CLI Architecture" width="800">
</div>

AIMTutor jest w pełni natywny dla CLI. Każda capability, baza wiedzy, sesja, memory i TutorBot są dostępne jednym poleceniem — bez konieczności przeglądarki. CLI służy zarówno ludziom (z bogatym renderingiem terminalowym), jak i agentom AI (z ustrukturyzowanym wyjściem JSON).

Przekaż [`SKILL.md`](../../SKILL.md) z katalogu głównego projektu dowolnemu agentowi używającemu narzędzi ([nanobot](https://github.com/HKUDS/nanobot) lub dowolny LLM z dostępem do narzędzi), a będzie mógł konfigurować i obsługiwać AIMTutor autonomicznie.
...
```bash
aimtutor kb create my-kb --doc textbook.pdf       # Utwórz z dokumentu
aimtutor kb add my-kb --docs-dir ./papers/         # Dodaj folder artykułów
aimtutor kb search my-kb "gradient descent"        # Szukaj bezpośrednio
aimtutor kb set-default my-kb                      # Ustaw jako domyślną dla wszystkich poleceń
```

**Tryb podwójnego wyjścia** — Bogaty rendering dla ludzi, ustrukturyzowany JSON dla potoków:

```bash
aimtutor run chat "Summarize chapter 3" -f rich    # Kolorowe, sformatowane wyjście
aimtutor run chat "Summarize chapter 3" -f json    # Zdarzenia JSON oddzielone liniami
```

**Ciągłość sesji** — Wznów dowolną rozmowę dokładnie tam, gdzie ją zostawiłeś:

```bash
aimtutor session list                              # Lista wszystkich sesji
aimtutor session open <id>                         # Wznów w REPL
```
...
| Polecenie | Opis |
|:---|:---|
| `aimtutor run <capability> <message>` | Uruchom dowolną capability w jednej turze (`chat`, `deep_solve`, `deep_question`, `deep_research`, `math_animator`, `visualize`) |
| `aimtutor chat` | Interaktywny REPL z opcjonalnym `--capability`, `--tool`, `--kb`, `--language` |
| `aimtutor serve` | Uruchom serwer API AIMTutor |

**`aimtutor bot`**

| Polecenie | Opis |
|:---|:---|
| `aimtutor bot list` | Lista wszystkich instancji TutorBot |
| `aimtutor bot create <id>` | Utwórz i uruchom nowego bota (`--name`, `--persona`, `--model`) |
| `aimtutor bot start <id>` | Uruchom bota |
| `aimtutor bot stop <id>` | Zatrzymaj bota |

**`aimtutor kb`**

| Polecenie | Opis |
|:---|:---|
| `aimtutor kb list` | Lista wszystkich baz wiedzy |
| `aimtutor kb info <name>` | Pokaż szczegóły bazy wiedzy |
| `aimtutor kb create <name>` | Utwórz z dokumentów (`--doc`, `--docs-dir`) |
| `aimtutor kb add <name>` | Dodawaj dokumenty przyrostowo |
| `aimtutor kb search <name> <query>` | Przeszukaj bazę wiedzy |
| `aimtutor kb set-default <name>` | Ustaw jako domyślną KB |
| `aimtutor kb delete <name>` | Usuń bazę wiedzy (`--force`) |

**`aimtutor memory`**

| Polecenie | Opis |
|:---|:---|
| `aimtutor memory show [file]` | Wyświetl pamięć (`summary`, `profile` lub `all`) |
| `aimtutor memory clear [file]` | Wyczyść pamięć (`--force`) |

**`aimtutor session`**

| Polecenie | Opis |
|:---|:---|
| `aimtutor session list` | Lista sesji (`--limit`) |
| `aimtutor session show <id>` | Wyświetl wiadomości sesji |
| `aimtutor session open <id>` | Wznów sesję w REPL |
| `aimtutor session rename <id>` | Zmień nazwę sesji (`--title`) |
| `aimtutor session delete <id>` | Usuń sesję |

**`aimtutor notebook`**

| Polecenie | Opis |
|:---|:---|
| `aimtutor notebook list` | Lista notatników |
| `aimtutor notebook create <name>` | Utwórz notatnik (`--description`) |
| `aimtutor notebook show <id>` | Wyświetl rekordy notatnika |
| `aimtutor notebook add-md <id> <path>` | Importuj markdown jako rekord |
| `aimtutor notebook replace-md <id> <rec> <path>` | Zastąp rekord markdown |
| `aimtutor notebook remove-record <id> <rec>` | Usuń rekord |

**`aimtutor book`**

| Polecenie | Opis |
|:---|:---|
| `aimtutor book list` | Lista wszystkich książek w workspace |
| `aimtutor book health <book_id>` | Sprawdź dryf KB i zdrowie książki |
| `aimtutor book refresh-fingerprints <book_id>` | Odśwież odciski palców KB i wyczyść przestarzałe strony |

**`aimtutor config` / `plugin` / `provider`**

| Polecenie | Opis |
|:---|:---|
| `aimtutor config show` | Wypisz podsumowanie bieżącej konfiguracji |
| `aimtutor plugin list` | Lista zarejestrowanych narzędzi i capabilities |
| `aimtutor plugin info <name>` | Pokaż szczegóły narzędzia lub capability |
| `aimtutor provider login <provider>` | Auth dostawcy (`openai-codex` logowanie OAuth; `github-copilot` waliduje istniejącą sesję auth Copilot) |
...
| `data/user/settings/system.json` | Nie | `aimtutor start` wyprowadza flagi auth frontendu oraz API base z ustawień runtime. |
...
AIMTutor stoi na ramionach wybitnych projektów open-source:

| Projekt | Rola w AIMTutor |
|:---|:---|
...
Mamy nadzieję, że AIMTutor stanie się prezentem dla społeczności. 🎁
...
[⭐ Oznacz nas gwiazdką](https://github.com/HKUDS/AIMTutor/stargazers) · [🐛 Zgłoś błąd](https://github.com/HKUDS/AIMTutor/issues) · [💬 Dyskusje](https://github.com/HKUDS/AIMTutor/discussions)
