...
Embedding configuration is now explicit about the exact URL AIMTutor will call.
...
- **Settings now shows Endpoint URL for embeddings** - the Web settings page
  labels embedding URLs as endpoint URLs and explains that AIMTutor posts to
...
**Full Changelog**: https://github.com/HKUDS/AIMTutor/compare/v1.3.1...v1.3.2
