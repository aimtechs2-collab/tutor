...
- **CLI** — `/regenerate` (alias `/retry`) inside the `aimtutor chat` REPL.
...
**Full Changelog**: https://github.com/HKUDS/AIMTutor/compare/v1.2.0...v1.2.1
