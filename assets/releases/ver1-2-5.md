...
- **Backend attachment store** — `aimtutor/services/storage/attachment_store.py` introduces a pluggable `AttachmentStore` protocol and a default `LocalDiskAttachmentStore` rooted at `data/user/workspace/chat/attachments`. The path can be overridden with `CHAT_ATTACHMENT_DIR`, documented in `.env.example`.
...
**Full Changelog**: https://github.com/HKUDS/AIMTutor/compare/v1.2.4...v1.2.5
