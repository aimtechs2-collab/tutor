...
AIMTutor now covers more hosted provider setups out of the box and keeps the
...
- **Dependency resolution is less fragile** - the NumPy upper bound was relaxed
  to support current Manim installs in `aimtutor[all]`, and Windows setup docs
...
**Full Changelog**: https://github.com/HKUDS/AIMTutor/compare/v1.3.2...v1.3.3
