...
- **Minimal thinking mode is provider-safe** - DeepSeek, DashScope, VolcEngine,
  ...
  `reasoning_effort=minimal`; AIMTutor sends the provider-specific disable
  signal instead.
...
- **`aimtutor start` launches the full web stack** - the CLI now delegates to
...
- Added CLI coverage so `aimtutor start` propagates the launcher exit code.
...
**Full Changelog**: https://github.com/HKUDS/AIMTutor/compare/v1.3.8...v1.3.9
