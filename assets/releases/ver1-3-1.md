...
- **Selected KB is now trusted system state** - chat RAG calls no longer let the
  LLM invent or override `kb_name`; the model only sees a `query`, and AIMTutor
...
- **Embedding responses are validated before use** - AIMTutor now rejects
...
**Full Changelog**: https://github.com/HKUDS/AIMTutor/compare/v1.3.0...v1.3.1
