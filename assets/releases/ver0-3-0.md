# 🚀 AIMTutor v0.3.0 Release Notes

**Release Date:** January 6, 2026

We're excited to announce AIMTutor v0.3.0! This release focuses on **developer experience improvements**, **CI/CD automation**, and **simplified local deployment**.
...
docker run -d --name aimtutor \
  ...
  --env-file .env \
  -v $(pwd)/data:/app/data \
  ghcr.io/hkuds/aimtutor:latest### 🏠 Local-First LLM Configuration
...
This aligns with AIMTutor's vision for privacy-first, self-hosted AI tutoring.

## 📦 What's Changed

### Core Infrastructure

- Added `aimtutor/core/prompt_manager.py` with singleton `PromptManager`
- Export `get_prompt_manager()` from `aimtutor/core/__init__.py`
...
- Deleted `aimtutor/agents/solve/utils/prompt_loader.py`
...
docker pull ghcr.io/hkuds/aimtutor:latest*Closes #33*
## What's Changed
* fix(UI): unrendered markdown in ActivityDetail card by @tusharkhatriofficial in https://github.com/HKUDS/AIMTutor/pull/26
* chore: transtale readme to ru by @oshliaer in https://github.com/HKUDS/AIMTutor/pull/27
* fix: improve reload_excludes configuration for uvicorn server and added support for newer models (openai) by @LouisACR in https://github.com/HKUDS/AIMTutor/pull/28
* feat: Dynamic LLM Provider Support (Local & Cloud) by @ahmedjawedaj in https://github.com/HKUDS/AIMTutor/pull/34

## 🤝New Contributors
* @oshliaer made their first contribution in https://github.com/HKUDS/AIMTutor/pull/27
* @LouisACR made their first contribution in https://github.com/HKUDS/AIMTutor/pull/28
* @ahmedjawedaj made their first contribution in https://github.com/HKUDS/AIMTutor/pull/34
