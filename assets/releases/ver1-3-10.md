# AIMTutor v1.3.10 Release Notes
...
- **Remote single-user Docker works out of the box again** - when
  `AUTH_ENABLED=false`, AIMTutor now accepts browser origins over HTTP/HTTPS so
...
- **Matrix no longer installs E2EE by default** - the standard `matrix` extra and
  ...
  Clang 21 (#462).
- **Encrypted rooms are an explicit add-on** - install `aimtutor[matrix-e2e]`
...
**Full Changelog**: https://github.com/HKUDS/AIMTutor/compare/v1.3.9...v1.3.10
