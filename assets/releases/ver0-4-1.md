...
**Removed `aimtutor/core` module** - All functionality migrated to `aimtutor/services`:

| Old Import | New Import |
|:---|:---|
| `from aimtutor.core.core import load_config_with_main` | `from aimtutor.services.config import load_config_with_main` |
| `from aimtutor.core.llm_factory import llm_complete` | `from aimtutor.services.llm import complete` |
| `from aimtutor.core.prompt_manager import get_prompt_manager` | `from aimtutor.services.prompt import get_prompt_manager` |
| `from aimtutor.core.logging import get_logger` | `from aimtutor.logging import get_logger` |
...
**Full Changelog**: https://github.com/HKUDS/AIMTutor/compare/v0.4.0...v0.4.1
