...
from aimtutor.app import AIMTutorApp, TurnRequest
...
# lives at module scope so a single ``aimtutor chat`` session shares one
# ring across turns; ``aimtutor run`` doesn't read it (single-shot mode),
...
async def render_turn_stream(*, app: AIMTutorApp, turn_id: str) -> None:
    content_buf = ""
    current_stage = ""
