...
const SPLIT_RATIO_KEY = "aimtutor.co_writer.split_ratio";
const SYNC_SCROLL_KEY = "aimtutor.co_writer.sync_scroll";
const LOCAL_DRAFT_PREFIX = "aimtutor.co_writer.draft.";
