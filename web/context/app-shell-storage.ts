...
export const ACTIVE_SESSION_STORAGE_KEY = "aimtutor.activeSessionId.tab";
export const LANGUAGE_STORAGE_KEY = "aimtutor-language";
export const SIDEBAR_COLLAPSED_STORAGE_KEY = "aimtutor.sidebarCollapsed";

export const ACTIVE_SESSION_EVENT = "aimtutor:active-session";
export const LANGUAGE_EVENT = "aimtutor:language";
export const SIDEBAR_COLLAPSED_EVENT = "aimtutor:sidebar-collapsed";
