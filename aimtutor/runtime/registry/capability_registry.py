...
from aimtutor.core.capability_protocol import BaseCapability
from aimtutor.runtime.bootstrap.builtin_capabilities import BUILTIN_CAPABILITY_CLASSES
...
def _load_plugin_hooks():
    try:
        module = importlib.import_module("aimtutor.plugins.loader")
    except Exception:
