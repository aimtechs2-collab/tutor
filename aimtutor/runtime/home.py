"""Runtime home resolution for installed and source AIMTutor runs."""
...
AIMTUTOR_HOME_ENV = "AIMTUTOR_HOME"
...
def get_runtime_home(home: str | Path | None = None) -> Path:
    ...
    2. ``AIMTUTOR_HOME`` environment variable.
    ...
    raw = home if home is not None else os.getenv(AIMTUTOR_HOME_ENV)
