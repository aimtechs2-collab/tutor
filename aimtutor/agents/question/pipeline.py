...
to :mod:`aimtutor.core.agentic` and the shared tool-composition policy.
"""
...
from aimtutor.core.agentic.labels import find_inline_labels
...
from aimtutor.services.config import parse_language
from aimtutor.services.llm import get_llm_config, prepare_multimodal_messages
...
from aimtutor.utils.json_parser import parse_json_response
    ...
    async def _summarize_tool_result(
        ...
        *,
        ...
        meta = build_trace_metadata(
            ...
            label=self._t("labels.reflecting", default="AIMTutor Reflecting..."),
        ...
        await stream.progress(
            self._t("labels.reflecting", default="AIMTutor Reflecting..."),
            source=SOURCE,
            stage=STAGE_EXPLORING,
