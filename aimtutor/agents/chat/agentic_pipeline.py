...
lives in :mod:`aimtutor.core.agentic`: label parsing, single-call streaming,
...
from aimtutor.agents._shared.tool_composition import (
    ToolMountFlags,
...
from aimtutor.capabilities._shared import emit_capability_result
from aimtutor.core.agentic import (
...
from aimtutor.core.agentic.labels import find_inline_labels, strip_label_probe_prefix
from aimtutor.core.agentic.tool_dispatch import MAX_PARALLEL_TOOL_CALLS
from aimtutor.core.context import UnifiedContext
from aimtutor.core.stream_bus import StreamBus
from aimtutor.core.trace import (
    build_trace_metadata,
    derive_trace_metadata,
    merge_trace_metadata,
    new_call_id,
)
from aimtutor.runtime.registry.tool_registry import get_tool_registry
from aimtutor.services.config import get_chat_params, load_system_settings  # noqa: F401
from aimtutor.services.llm import (
    clean_thinking_tags,
    get_llm_config,
...
from aimtutor.services.prompt import get_prompt_manager
from aimtutor.services.prompt.language import append_language_directive
...
def _classify_answer_now_label(
    ...
    *,
    ...
    """
    from aimtutor.core.agentic.labels import classify_label
...
class AgenticChatPipeline:
    ...
    async def run(self, context: UnifiedContext, stream: StreamBus) -> None:
        ...
        # ``currentStage`` indicator ("AIMTutor responding…"). It carries no
    ...
    async def _execute_tool_call(
        ...
        *,
        ...
        """
        from aimtutor.core.agentic import execute_tool_call
    ...
    def _estimate_messages_tokens(messages: list[dict[str, Any]]) -> int:
        ...
        from aimtutor.services.session.context_builder import count_tokens
    ...
    def _build_system_prompt(
        ...
        # YAML under ``aimtutor/tools/prompting/hints/{lang}/{tool}.yaml``.
...
class _ChatLoopHost:
    ...
    :class:`~aimtutor.core.agentic.LoopHost` protocol calls to them.
    """
