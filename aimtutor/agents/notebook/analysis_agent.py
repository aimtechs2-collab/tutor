...
from aimtutor.core.trace import build_trace_metadata, derive_trace_metadata, new_call_id
from aimtutor.services.llm import clean_thinking_tags, get_llm_config, get_token_limit_kwargs
from aimtutor.services.llm import stream as llm_stream
from aimtutor.services.prompt.manager import get_prompt_manager
...
class NotebookAnalysisAgent:
    ...
    def __init__(self, language: str = "en") -> None:
        ...
        # Prompts come from aimtutor/agents/notebook/prompts/{en,zh}/analysis_agent.yaml
