...
from aimtutor.config.settings import settings
from aimtutor.logging import LLMStats
from aimtutor.services.config import get_agent_params
...
class BaseAgent(ABC):
    ...
    def __init__(
        ...
        self.logger = logging.getLogger(f"aimtutor.{logger_name}")
