...
from aimtutor.agents.research.data_structures import (
    DynamicTopicQueue,
    ToolTrace,
    TopicBlock,
    TopicStatus,
)
from aimtutor.agents.research.utils.citation_manager import CitationManager
...
from aimtutor.core.agentic.tool_dispatch import (
...
class ResearchPipeline:
    ...
    LLM call goes through :mod:`aimtutor.core.agentic` primitives. The
...
class _RephraseLoopHost:
    ...
    async def resolve_pause(self, dispatch: DispatchOutcome) -> bool:
        from aimtutor.agents.chat.agentic_pipeline import (
