...
from aimtutor.agents.auto.delegation import (
    AtomicToolResult,
    DelegationResult,
    delegate_with_retry,
    execute_atomic_tool,
)
from aimtutor.agents.auto.prompts import (
    analyzer_system_prompt,
    pick_language,
    router_system_prompt,
    synthesizer_system_prompt,
)
from aimtutor.agents.auto.schemas import (
...
from aimtutor.core.agentic.usage import UsageTracker
...
from aimtutor.services.config import load_system_settings
from aimtutor.services.llm import get_llm_config
...
class AutoPipeline:
    ...
    def _completion_kwargs(self, max_tokens: int) -> dict[str, Any]:
        return build_completion_kwargs(
            ...
            reasoning_effort=getattr(self.llm_config, "reasoning_effort", None),
        )
