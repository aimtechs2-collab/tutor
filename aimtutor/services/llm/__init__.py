...
Unified LLM service for all AIMTutor modules.
...
Usage:
    ...
    from aimtutor.services.llm import complete, stream
    ...
    # Configuration
    from aimtutor.services.llm import get_llm_config, LLMConfig
    config = get_llm_config()

    # URL utilities for local LLM servers
    from aimtutor.services.llm import sanitize_url, is_local_llm_server
"""
...
def __getattr__(name: str):
    ...
    if name == "cloud_provider":
        return import_module("aimtutor.services.llm.cloud_provider")
    if name == "local_provider":
        return import_module("aimtutor.services.llm.local_provider")
