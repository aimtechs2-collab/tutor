"""LlamaIndex embedding adapter backed by AIMTutor's embedding service."""
...
from aimtutor.services.embedding import EmbeddingConfig, get_embedding_client, get_embedding_config
from aimtutor.services.embedding.validation import validate_embedding_batch
...
class CustomEmbedding(BaseEmbedding):
    """Custom LlamaIndex embedding adapter for AIMTutor embedding providers."""
...
def configure_llamaindex_settings(logger=None) -> None:
    """Configure LlamaIndex globals for AIMTutor's current embedding config."""
