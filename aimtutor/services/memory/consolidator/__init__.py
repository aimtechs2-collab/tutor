...
* :class:`ConsolidateResult`, :data:`OnEvent` — legacy types preserved
  for :mod:`aimtutor.services.memory.store`.
...
from aimtutor.services.memory.consolidator.guards import _filter_banned, _has_banned
from aimtutor.services.memory.consolidator.modes import (
    consolidate_l2,
    consolidate_l3,
    run_audit,
    run_dedup,
...
from aimtutor.services.memory.consolidator.parse import _parse_ops_response
