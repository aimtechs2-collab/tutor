...
from aimtutor.services.memory import paths
from aimtutor.services.memory import snapshot as snap
from aimtutor.services.memory.consolidator.chunker import (
    chunk_with_boundary,
)
from aimtutor.services.memory.consolidator.meta import (
    load_l2_meta,
    load_l3_meta,
    save_l2_meta,
    save_l3_meta,
)
from aimtutor.services.memory.consolidator.modes._runtime import (
    OnEvent,
    call_llm,
    emit,
    load_doc,
...
from aimtutor.services.memory.consolidator.references import (
    ExtractedFact,
    refs_in_span_l2,
    refs_in_span_l3,
...
from aimtutor.services.memory.document import Document, Entry, serialize
from aimtutor.services.memory.ops import AddOp
from aimtutor.services.memory.ops import apply as apply_ops
from aimtutor.services.memory.paths import L3Slot, Surface
from aimtutor.services.memory.settings import load_memory_settings
    ...
    *,
    ...
    if not new_entities:
        ...
        if settings.merge.auto_after_update:
            from aimtutor.services.memory.consolidator.modes.merge import run_merge
    ...
    if settings.dedup.auto_after_update and facts_added > 0:
        ...
        from aimtutor.services.memory.consolidator.modes.dedup import run_dedup
...
def _load_all_l2_docs() -> dict[str, Document]:
    from aimtutor.services.memory.document import parse
