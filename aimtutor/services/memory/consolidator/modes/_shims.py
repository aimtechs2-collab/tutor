"""Legacy public-API shims for :mod:`aimtutor.services.memory.store`.
...
from aimtutor.services.memory.consolidator.modes.update import (
    UpdateResult,
    run_update,
)
from aimtutor.services.memory.document import parse, serialize
from aimtutor.services.memory.ops import ApplyReport, Op
