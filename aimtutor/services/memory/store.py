...
from aimtutor.services.memory import consolidator, paths, trace
from aimtutor.services.memory.consolidator import ConsolidateResult, OnEvent
from aimtutor.services.memory.document import Document, parse, serialize
from aimtutor.services.memory.ops import AddOp, ApplyReport, EditOp
from aimtutor.services.memory.ops import apply as ops_apply
...
_NO_MEMORY = (
    "(No memory available — interact with AIMTutor and update from the Memory page to build one.)"
)
...
class MemoryStore:
    ...
    async def apply_ops_payload(
        ...
        """
        from aimtutor.services.memory.consolidator import _parse_ops_response
