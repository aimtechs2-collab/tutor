"""Nanobot-style normalized runtime configuration for AIMTutor."""
...
from aimtutor.services.model_selection import LLMSelection, apply_llm_selection_to_catalog
from aimtutor.services.provider_registry import (
