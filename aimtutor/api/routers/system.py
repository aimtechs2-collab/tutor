...
from aimtutor.services.config import resolve_search_runtime_config
from aimtutor.services.embedding import get_embedding_client, get_embedding_config
from aimtutor.services.llm import complete as llm_complete
from aimtutor.services.llm import get_llm_config, get_token_limit_kwargs
...
async def test_search_connection():
    ...
    try:
        ...
        result = web_search("AIMTutor health check", provider=search_config.provider)
        response_time = (time.time() - start_time) * 1000
