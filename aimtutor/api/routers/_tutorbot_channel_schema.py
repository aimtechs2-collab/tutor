...
Why live here vs inside ``aimtutor.tutorbot.channels``?
...
from aimtutor.services.tutorbot.manager import _is_secret_field
...
def all_channel_schemas() -> dict[str, dict[str, Any]]:
    ...
    from aimtutor.tutorbot.channels.registry import discover_all
