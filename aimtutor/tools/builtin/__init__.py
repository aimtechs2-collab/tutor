...
from aimtutor.core.tool_protocol import BaseTool, ToolDefinition, ToolParameter, ToolResult
from aimtutor.tools.prompting import load_prompt_hints
...
class BrainstormTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from aimtutor.tools.brainstorm import brainstorm
...
"""
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from aimtutor.tools.code_executor import run_code
    ...
    async def _generate_code(self, intent: str) -> str:
        from aimtutor.services.llm import complete, get_token_limit_kwargs
...
class ReasonTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from aimtutor.tools.reason import reason
...
class PaperSearchToolWrapper(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from aimtutor.tools.paper_search_tool import ArxivSearchTool
...
class GeoGebraAnalysisTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from aimtutor.agents.vision_solver.vision_solver_agent import VisionSolverAgent
        from aimtutor.services.llm.config import get_llm_config
...
class WriteMemoryTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from aimtutor.services.memory import get_memory_store
        from aimtutor.services.memory.trace import TraceEvent
...
class WebFetchTool(_PromptHintsMixin, BaseTool):
    ...
    ``aimtutor.tools.web_fetch`` so this wrapper stays free of network
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from aimtutor.tools.web_fetch import (
            DEFAULT_MAX_CHARS,
...
class ListNotebookTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from aimtutor.tools.list_notebook import list_notebooks_or_records
...
class GithubTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from aimtutor.tools.github_query import run_github_query
...
class AskUserTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from aimtutor.tools.ask_user import build_ask_user_payload
