...
_CONFIGURED = False
_MANAGED_ATTR = "_aimtutor_managed"
...
def configure_logging(force: bool = False) -> LoggingConfig:
    ...
    logging.getLogger("aimtutor").setLevel(logging.DEBUG)
    logging.getLogger("aimtutor").propagate = True
