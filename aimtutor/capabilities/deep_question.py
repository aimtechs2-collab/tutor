...
from aimtutor.capabilities._i18n import StatusI18n
...
from aimtutor.core.trace import merge_trace_metadata
...
class DeepQuestionCapability(BaseCapability):
    ...
    async def run(self, context: UnifiedContext, stream: StreamBus) -> None:
        ...
        if isinstance(followup_question_context, dict) and followup_question_context.get(
            ...
            from aimtutor.agents.question.agents.followup_agent import FollowupAgent
        ...
        if mode != "mimic":
            ...
            from aimtutor.agents.question.history import load_session_quiz_history
            from aimtutor.agents.question.pipeline import QuestionPipeline
            from aimtutor.agents.question.request_config import (
    ...
    async def _run_mimic_mode(
        ...
        * ``[Attached Documents]`` in  → no paper available; fall back to
        ...
        """
        from aimtutor.agents.question.history import load_session_quiz_history
        from aimtutor.agents.question.mimic_source import (
