...
TutorBot shares a three-file memory system with AIMTutor. These files persist across sessions and are automatically loaded into your context.

## Structure

| File | Purpose | Loaded |
|------|---------|--------|
| `SUMMARY.md` | Chronological log of all interactions (both AIMTutor and TutorBot) | Yes |
