...
from aimtutor.tutorbot.utils.helpers import build_assistant_message, detect_image_mime
...
"""
        ...
        if self.shared_memory_dir:
            name = "TutorBot"
            tagline = "You are TutorBot, an intelligent learning companion powered by AIMTutor."
        else:
            name = "TutorBot"
...
Reply directly with text for conversations. Only use the 'message' tool to send to a specific chat channel."""
    ...
    def _build_shared_memory(self) -> str:
        """Build memory context from AIMTutor's shared memory (PROFILE + SUMMARY).
