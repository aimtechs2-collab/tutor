...
class AIMTutorError(Exception):
    """Base class for all application errors in AIMTutor."""
...
class ConfigurationError(AIMTutorError):
    """Raised when there's a configuration-related error."""

    pass


class ValidationError(AIMTutorError):
    """Raised when input validation fails."""

    pass


class ServiceError(AIMTutorError):
