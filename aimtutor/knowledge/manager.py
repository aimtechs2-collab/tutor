...
from aimtutor.services.rag.factory import DEFAULT_PROVIDER, normalize_provider_name
...
def _get_embedding_fingerprint() -> tuple[str, int] | None:
    ...
    try:
        from aimtutor.services.embedding import get_embedding_config
...
class KnowledgeBaseManager:
    ...
    def update_kb_status(
        ...
        if status == "ready":
            ...
            try:
                from aimtutor.services.rag.embedding_signature import (
