...
class ProgressTracker:
    ...
    def _notify(self, progress: dict):
        ...
        from aimtutor.runtime.mode import is_server
    ...
    def update(
        ...
        try:
            ...
            fallback_logger = logging.getLogger("aimtutor.ProgressTracker")
            prefix = f"[{self.task_id}]" if self.task_id else ""
        ...
        if self.task_id:
            try:
                from aimtutor.api.utils.task_log_stream import get_task_stream_manager
